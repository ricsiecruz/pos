...
var _WebSocketService = class _WebSocketService {
  ...
  constructor() {
    ...
    this.socket$.subscribe(() => console.log("WebSocket connection established"), (error) => console.error("WebSocket connection error:", error), () => console.log("WebSocket connection closed"));
  }
  send(message) {
...
var _SalesService = class _SalesService {
  constructor(http, webSocketService) {
    ...
    this.API_URL = "https://pos-backend-kt9t.vercel.app/";
    this.salesSubject = new BehaviorSubject([]);
    this.sales$ = this.salesSubject.asObservable();
    this.websocketSubscription = merge(this.webSocketService.receive().pipe(map((message) => {
    ...
    })), this.http.get(this.API_URL + "sales")).subscribe((data) => {
...
_SalesService.\u0275fac = function SalesService_Factory(t) {
  return new (t || _SalesService)(\u0275\u0275inject(HttpClient), \u0275\u0275inject(WebSocketService));
};
_SalesService.\u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({ token: _SalesService, factory: _SalesService.\u0275fac, providedIn: "root" });
...
var _ExpensesService = class _ExpensesService {
  constructor(http, webSocketService) {
    ...
    this.expensesSubject = new BehaviorSubject([]);
    ...
    })), this.http.get(this.API_URL + "expenses")).subscribe((data) => {
      if (Array.isArray(data)) {
  ...
  editExpenses(expenseId, updatedExpenses) {
...
_ExpensesService.\u0275fac = function ExpensesService_Factory(t) {
  return new (t || _ExpensesService)(\u0275\u0275inject(HttpClient), \u0275\u0275inject(WebSocketService));
};
...
var _DashboardComponent = class _DashboardComponent {
  constructor(salesService, expensesService) {
...
_DashboardComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _DashboardComponent, selectors: [["app-dashboard"]], viewQuery: function DashboardComponent_Query(rf, ctx) {
  ...
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd()()();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(10, "div", 7)(11, "div")(12, "div", 8);
    \u0275\u0275text(13, " EXPENSES ");
    \u0275\u0275elementEnd();
    \u0275\u0275text(14);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275elementEnd()()();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(18, "div", 11)(19, "div")(20, "div", 12);
    \u0275\u0275text(21, " CUPS SOLD ");
    \u0275\u0275elementEnd();
    \u0275\u0275text(22);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    \u0275\u0275advance(6);
    \u0275\u0275textInterpolate1(" PHP ", ctx.totalSum, " ");
    \u0275\u0275advance(8);
    \u0275\u0275textInterpolate1(" PHP ", ctx.totalExpenses, " ");
    \u0275\u0275advance(8);
    \u0275\u0275textInterpolate1(" PHP ", ctx.totalCups, " ");
  }
}, styles: ["\n\n@media (max-width: 575.98px) {\n  .dashboard[_ngcontent-%COMP%] {\n    padding: 20px;\n  }\n}\n.dashboard_cards[_ngcontent-%COMP%] {\n  display: flex;\n  justify-content: space-between;\n}\n@media (max-width: 575.98px) {\n  .dashboard_cards[_ngcontent-%COMP%] {\n    display: block;\n  }\n}\n.dashboard_cards_income[_ngcontent-%COMP%], .dashboard_cards_expenses[_ngcontent-%COMP%], .dashboard_cards_cups[_ngcontent-%COMP%] {\n  font-weight: 700;\n  font-size: 18px;\n  color: #ffffff;\n  height: 98px;\n  width: 380px;\n  border-radius: 6px;\n  display: -webkit-box;\n  display: -ms-flexbox;\n  display: flex;\n  align-items: center;\n  -webkit-box-align: center;\n  -ms-flex-align: center;\n  justify-content: space-between;\n  -webkit-justify-content: space-between;\n  -ms-flex-pack: space-between;\n  margin: 0 0 25px;\n  padding: 20px;\n}\n@media (max-width: 575.98px) {\n  .dashboard_cards_income[_ngcontent-%COMP%], .dashboard_cards_expenses[_ngcontent-%COMP%], .dashboard_cards_cups[_ngcontent-%COMP%] {\n    width: 100%;\n  }\n}\n.dashboard_cards_income_header[_ngcontent-%COMP%], .dashboard_cards_expenses_header[_ngcontent-%COMP%], .dashboard_cards_cups_header[_ngcontent-%COMP%] {\n  font-size: 14px;\n  font-weight: normal;\n}\n.dashboard_cards_income_icon[_ngcontent-%COMP%], .dashboard_cards_expenses_icon[_ngcontent-%COMP%], .dashboard_cards_cups_icon[_ngcontent-%COMP%] {\n  background-color: #d2d2d2;\n  width: 48px;\n  height: 48px;\n  display: -webkit-box;\n  display: -ms-flexbox;\n  display: flex;\n  align-items: center;\n  -webkit-box-align: center;\n  -ms-flex-align: center;\n  justify-content: center;\n  -webkit-justify-content: center;\n  -ms-flex-pack: center;\n  border-radius: 50px;\n}\n.dashboard_cards_income_icon[_ngcontent-%COMP%]   svg[_ngcontent-%COMP%], .dashboard_cards_expenses_icon[_ngcontent-%COMP%]   svg[_ngcontent-%COMP%], .dashboard_cards_cups_icon[_ngcontent-%COMP%]   svg[_ngcontent-%COMP%] {\n  width: 34px;\n}\n.dashboard_cards_income[_ngcontent-%COMP%] {\n  background: #1B2850;\n}\n.dashboard_cards_income_icon[_ngcontent-%COMP%]   svg[_ngcontent-%COMP%] {\n  fill: #1b2850;\n}\n.dashboard_cards_expenses[_ngcontent-%COMP%] {\n  background-color: #FF4D4D;\n}\n.dashboard_cards_expenses_icon[_ngcontent-%COMP%]   svg[_ngcontent-%COMP%] {\n  fill: #FF4D4D;\n}\n.dashboard_cards_cups[_ngcontent-%COMP%] {\n  background-color: #28C76F;\n}\n.dashboard_cards_cups_icon[_ngcontent-%COMP%]   svg[_ngcontent-%COMP%] {\n  fill: #28C76F;\n}\n/*# sourceMappingURL=dashboard.component.css.map */"] });
...
var _InventoryService = class _InventoryService {
  constructor(http, webSocketService) {
    ...
    this.webSocketService = webSocketService;
    this.API_URL = "https://pos-backend-kt9t.vercel.app/";
    this.inventorySubject = new BehaviorSubject([]);
    ...
    })), this.http.get(this.API_URL + "inventory")).subscribe((data) => {
...
_InventoryService.\u0275fac = function InventoryService_Factory(t) {
  return new (t || _InventoryService)(\u0275\u0275inject(HttpClient), \u0275\u0275inject(WebSocketService));
};
...
_NgbAlert.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({
  ...
  consts: () => {
    let i18n_0;
    if (false) {
      const MSG__USERS_RICSIECRUZ_DOCUMENTS_POS_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_MJS_0 = goog.getMsg("Close");
      i18n_0 = MSG__USERS_RICSIECRUZ_DOCUMENTS_POS_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_MJS_0;
    } else {
...
_NgbCarousel.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({
  ...
  consts: () => {
    let i18n_1;
    if (false) {
      const MSG__USERS_RICSIECRUZ_DOCUMENTS_POS_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_MJS_1 = goog.getMsg(" Slide {$interpolation} of {$interpolation_1} ", {
        "interpolation": "\uFFFD0\uFFFD",
        "interpolation_1": "\uFFFD1\uFFFD"
      }, {
        original_code: {
      ...
      i18n_1 = MSG__USERS_RICSIECRUZ_DOCUMENTS_POS_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_MJS_1;
    } else {
    ...
    let i18n_2;
    if (false) {
      const MSG__USERS_RICSIECRUZ_DOCUMENTS_POS_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_MJS_2 = goog.getMsg("Previous");
      i18n_2 = MSG__USERS_RICSIECRUZ_DOCUMENTS_POS_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_MJS_2;
    } else {
      i18n_2 = $localize`:@@ngb.carousel.previous:Previous`;
    }
    let i18n_3;
    if (false) {
      const MSG__USERS_RICSIECRUZ_DOCUMENTS_POS_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_MJS_3 = goog.getMsg("Next");
      i18n_3 = MSG__USERS_RICSIECRUZ_DOCUMENTS_POS_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_MJS_3;
    } else {
...
_NgbDatepickerNavigationSelect.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({
  ...
  consts: () => {
    let i18n_4;
    if (false) {
      const MSG__USERS_RICSIECRUZ_DOCUMENTS_POS_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_MJS_4 = goog.getMsg("Select month");
      i18n_4 = MSG__USERS_RICSIECRUZ_DOCUMENTS_POS_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_MJS_4;
    } else {
      i18n_4 = $localize`:@@ngb.datepicker.select-month:Select month`;
    }
    let i18n_5;
    if (false) {
      const MSG__USERS_RICSIECRUZ_DOCUMENTS_POS_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_MJS_5 = goog.getMsg("Select month");
      i18n_5 = MSG__USERS_RICSIECRUZ_DOCUMENTS_POS_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_MJS_5;
    } else {
      i18n_5 = $localize`:@@ngb.datepicker.select-month:Select month`;
    }
    let i18n_6;
    if (false) {
      const MSG__USERS_RICSIECRUZ_DOCUMENTS_POS_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_MJS_6 = goog.getMsg("Select year");
      i18n_6 = MSG__USERS_RICSIECRUZ_DOCUMENTS_POS_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_MJS_6;
    } else {
      i18n_6 = $localize`:@@ngb.datepicker.select-year:Select year`;
    }
    let i18n_7;
    if (false) {
      const MSG__USERS_RICSIECRUZ_DOCUMENTS_POS_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_MJS_7 = goog.getMsg("Select year");
      i18n_7 = MSG__USERS_RICSIECRUZ_DOCUMENTS_POS_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_MJS_7;
    } else {
...
_NgbDatepickerNavigation.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({
  ...
  consts: () => {
    let i18n_8;
    if (false) {
      const MSG__USERS_RICSIECRUZ_DOCUMENTS_POS_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_MJS_8 = goog.getMsg("Previous month");
      i18n_8 = MSG__USERS_RICSIECRUZ_DOCUMENTS_POS_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_MJS_8;
    } else {
      i18n_8 = $localize`:@@ngb.datepicker.previous-month:Previous month`;
    }
    let i18n_9;
    if (false) {
      const MSG__USERS_RICSIECRUZ_DOCUMENTS_POS_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_MJS_9 = goog.getMsg("Previous month");
      i18n_9 = MSG__USERS_RICSIECRUZ_DOCUMENTS_POS_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_MJS_9;
    } else {
      i18n_9 = $localize`:@@ngb.datepicker.previous-month:Previous month`;
    }
    let i18n_10;
    if (false) {
      const MSG__USERS_RICSIECRUZ_DOCUMENTS_POS_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_MJS_10 = goog.getMsg("Next month");
      i18n_10 = MSG__USERS_RICSIECRUZ_DOCUMENTS_POS_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_MJS_10;
    } else {
      i18n_10 = $localize`:@@ngb.datepicker.next-month:Next month`;
    }
    let i18n_11;
    if (false) {
      const MSG__USERS_RICSIECRUZ_DOCUMENTS_POS_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_MJS_11 = goog.getMsg("Next month");
      i18n_11 = MSG__USERS_RICSIECRUZ_DOCUMENTS_POS_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_MJS_11;
    } else {
...
_NgbPagination.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({
  ...
  consts: () => {
    let i18n_12;
    if (false) {
      const MSG__USERS_RICSIECRUZ_DOCUMENTS_POS_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_MJS_12 = goog.getMsg("\xAB\xAB");
      i18n_12 = MSG__USERS_RICSIECRUZ_DOCUMENTS_POS_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_MJS_12;
    } else {
      i18n_12 = $localize`:@@ngb.pagination.first:««`;
    }
    let i18n_13;
    if (false) {
      const MSG__USERS_RICSIECRUZ_DOCUMENTS_POS_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_MJS_13 = goog.getMsg("\xAB");
      i18n_13 = MSG__USERS_RICSIECRUZ_DOCUMENTS_POS_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_MJS_13;
    } else {
      i18n_13 = $localize`:@@ngb.pagination.previous:«`;
    }
    let i18n_14;
    if (false) {
      const MSG__USERS_RICSIECRUZ_DOCUMENTS_POS_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_MJS_14 = goog.getMsg("\xBB");
      i18n_14 = MSG__USERS_RICSIECRUZ_DOCUMENTS_POS_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_MJS_14;
    } else {
      i18n_14 = $localize`:@@ngb.pagination.next:»`;
    }
    let i18n_15;
    if (false) {
      const MSG__USERS_RICSIECRUZ_DOCUMENTS_POS_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_MJS_15 = goog.getMsg("\xBB\xBB");
      i18n_15 = MSG__USERS_RICSIECRUZ_DOCUMENTS_POS_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_MJS_15;
    } else {
      i18n_15 = $localize`:@@ngb.pagination.last:»»`;
    }
    let i18n_16;
    if (false) {
      const MSG__USERS_RICSIECRUZ_DOCUMENTS_POS_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_MJS_16 = goog.getMsg("First");
      i18n_16 = MSG__USERS_RICSIECRUZ_DOCUMENTS_POS_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_MJS_16;
    } else {
      i18n_16 = $localize`:@@ngb.pagination.first-aria:First`;
    }
    let i18n_17;
    if (false) {
      const MSG__USERS_RICSIECRUZ_DOCUMENTS_POS_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_MJS_17 = goog.getMsg("Previous");
      i18n_17 = MSG__USERS_RICSIECRUZ_DOCUMENTS_POS_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_MJS_17;
    } else {
      i18n_17 = $localize`:@@ngb.pagination.previous-aria:Previous`;
    }
    let i18n_18;
    if (false) {
      const MSG__USERS_RICSIECRUZ_DOCUMENTS_POS_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_MJS_18 = goog.getMsg("Next");
      i18n_18 = MSG__USERS_RICSIECRUZ_DOCUMENTS_POS_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_MJS_18;
    } else {
      i18n_18 = $localize`:@@ngb.pagination.next-aria:Next`;
    }
    let i18n_19;
    if (false) {
      const MSG__USERS_RICSIECRUZ_DOCUMENTS_POS_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_MJS_19 = goog.getMsg("Last");
      i18n_19 = MSG__USERS_RICSIECRUZ_DOCUMENTS_POS_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_MJS_19;
    } else {
...
_NgbProgressbar.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({
  ...
  consts: () => {
    let i18n_20;
    if (false) {
      const MSG__USERS_RICSIECRUZ_DOCUMENTS_POS_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_MJS_20 = goog.getMsg("{$interpolation}", {
        "interpolation": "\uFFFD0\uFFFD"
      }, {
        original_code: {
      ...
      i18n_20 = MSG__USERS_RICSIECRUZ_DOCUMENTS_POS_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_MJS_20;
    } else {
...
_NgbTimepicker.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({
  ...
  consts: () => {
    let i18n_21;
    if (false) {
      const MSG__USERS_RICSIECRUZ_DOCUMENTS_POS_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_MJS_21 = goog.getMsg("HH");
      i18n_21 = MSG__USERS_RICSIECRUZ_DOCUMENTS_POS_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_MJS_21;
    } else {
      i18n_21 = $localize`:@@ngb.timepicker.HH:HH`;
    }
    let i18n_22;
    if (false) {
      const MSG__USERS_RICSIECRUZ_DOCUMENTS_POS_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_MJS_22 = goog.getMsg("Hours");
      i18n_22 = MSG__USERS_RICSIECRUZ_DOCUMENTS_POS_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_MJS_22;
    } else {
      i18n_22 = $localize`:@@ngb.timepicker.hours:Hours`;
    }
    let i18n_23;
    if (false) {
      const MSG__USERS_RICSIECRUZ_DOCUMENTS_POS_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_MJS_23 = goog.getMsg("MM");
      i18n_23 = MSG__USERS_RICSIECRUZ_DOCUMENTS_POS_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_MJS_23;
    } else {
      i18n_23 = $localize`:@@ngb.timepicker.MM:MM`;
    }
    let i18n_24;
    if (false) {
      const MSG__USERS_RICSIECRUZ_DOCUMENTS_POS_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_MJS_24 = goog.getMsg("Minutes");
      i18n_24 = MSG__USERS_RICSIECRUZ_DOCUMENTS_POS_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_MJS_24;
    } else {
      i18n_24 = $localize`:@@ngb.timepicker.minutes:Minutes`;
    }
    let i18n_25;
    if (false) {
      const MSG__USERS_RICSIECRUZ_DOCUMENTS_POS_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_MJS_25 = goog.getMsg("Increment hours");
      i18n_25 = MSG__USERS_RICSIECRUZ_DOCUMENTS_POS_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_MJS_25;
    } else {
      i18n_25 = $localize`:@@ngb.timepicker.increment-hours:Increment hours`;
    }
    let i18n_26;
    if (false) {
      const MSG__USERS_RICSIECRUZ_DOCUMENTS_POS_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_MJS_26 = goog.getMsg("Decrement hours");
      i18n_26 = MSG__USERS_RICSIECRUZ_DOCUMENTS_POS_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_MJS_26;
    } else {
      i18n_26 = $localize`:@@ngb.timepicker.decrement-hours:Decrement hours`;
    }
    let i18n_27;
    if (false) {
      const MSG__USERS_RICSIECRUZ_DOCUMENTS_POS_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_MJS_27 = goog.getMsg("Increment minutes");
      i18n_27 = MSG__USERS_RICSIECRUZ_DOCUMENTS_POS_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_MJS_27;
    } else {
      i18n_27 = $localize`:@@ngb.timepicker.increment-minutes:Increment minutes`;
    }
    let i18n_28;
    if (false) {
      const MSG__USERS_RICSIECRUZ_DOCUMENTS_POS_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_MJS_28 = goog.getMsg("Decrement minutes");
      i18n_28 = MSG__USERS_RICSIECRUZ_DOCUMENTS_POS_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_MJS_28;
    } else {
      i18n_28 = $localize`:@@ngb.timepicker.decrement-minutes:Decrement minutes`;
    }
    let i18n_29;
    if (false) {
      const MSG__USERS_RICSIECRUZ_DOCUMENTS_POS_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_MJS_29 = goog.getMsg("SS");
      i18n_29 = MSG__USERS_RICSIECRUZ_DOCUMENTS_POS_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_MJS_29;
    } else {
      i18n_29 = $localize`:@@ngb.timepicker.SS:SS`;
    }
    let i18n_30;
    if (false) {
      const MSG__USERS_RICSIECRUZ_DOCUMENTS_POS_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_MJS_30 = goog.getMsg("Seconds");
      i18n_30 = MSG__USERS_RICSIECRUZ_DOCUMENTS_POS_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_MJS_30;
    } else {
      i18n_30 = $localize`:@@ngb.timepicker.seconds:Seconds`;
    }
    let i18n_31;
    if (false) {
      const MSG__USERS_RICSIECRUZ_DOCUMENTS_POS_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_MJS_31 = goog.getMsg("Increment seconds");
      i18n_31 = MSG__USERS_RICSIECRUZ_DOCUMENTS_POS_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_MJS_31;
    } else {
      i18n_31 = $localize`:@@ngb.timepicker.increment-seconds:Increment seconds`;
    }
    let i18n_32;
    if (false) {
      const MSG__USERS_RICSIECRUZ_DOCUMENTS_POS_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_MJS_32 = goog.getMsg("Decrement seconds");
      i18n_32 = MSG__USERS_RICSIECRUZ_DOCUMENTS_POS_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_MJS_32;
    } else {
      i18n_32 = $localize`:@@ngb.timepicker.decrement-seconds:Decrement seconds`;
    }
    let i18n_33;
    if (false) {
      const MSG__USERS_RICSIECRUZ_DOCUMENTS_POS_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_MJS_33 = goog.getMsg("{$interpolation}", {
        "interpolation": "\uFFFD0\uFFFD"
      }, {
        original_code: {
      ...
      i18n_33 = MSG__USERS_RICSIECRUZ_DOCUMENTS_POS_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_MJS_33;
    } else {
...
_NgbToast.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({
  ...
  consts: () => {
    let i18n_34;
    if (false) {
      const MSG__USERS_RICSIECRUZ_DOCUMENTS_POS_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_MJS_34 = goog.getMsg("Close");
      i18n_34 = MSG__USERS_RICSIECRUZ_DOCUMENTS_POS_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_MJS_34;
    } else {
...
_ModalService.\u0275fac = function ModalService_Factory(t) {
  return new (t || _ModalService)(\u0275\u0275inject(NgbModal));
};
...
// src/app/admin/no-data/no-data.component.ts
...
_NoDataComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _NoDataComponent, selectors: [["app-no-data"]], decls: 4, vars: 0, consts: [[1, "no-data"], ["xmlns", "http://www.w3.org/2000/svg", "viewBox", "0 0 24 24", "fill", "currentColor"], ["d", "M4.02381 3.78307C4.12549 3.32553 4.5313 3 5 3H19C19.4687 3 19.8745 3.32553 19.9762 3.78307L21.9762 12.7831C21.992 12.8543 22 12.927 22 13V20C22 20.5523 21.5523 21 21 21H3C2.44772 21 2 20.5523 2 20V13C2 12.927 2.00799 12.8543 2.02381 12.7831L4.02381 3.78307ZM5.80217 5L4.24662 12H9C9 13.6569 10.3431 15 12 15C13.6569 15 15 13.6569 15 12H19.7534L18.1978 5H5.80217ZM16.584 14C15.8124 15.7659 14.0503 17 12 17C9.94968 17 8.1876 15.7659 7.41604 14H4V19H20V14H16.584Z"]], template: function NoDataComponent_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 0);
    \u0275\u0275namespaceSVG();
    ...
    \u0275\u0275element(2, "path", 2);
    \u0275\u0275elementEnd();
    \u0275\u0275text(3, " No data available\n");
    \u0275\u0275elementEnd();
  }
}, styles: ["\n\n.no-data[_ngcontent-%COMP%] {\n  display: grid;\n  place-items: center;\n  color: #5b6670;\n  padding: 50px;\n}\n.no-data[_ngcontent-%COMP%]   svg[_ngcontent-%COMP%] {\n  width: 50px;\n  color: #fb0;\n}\n/*# sourceMappingURL=no-data.component.css.map */"] });
var NoDataComponent = _NoDataComponent;
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(NoDataComponent, { className: "NoDataComponent" });
})();

// src/app/admin/inventory/inventory.component.ts
var _c03 = ["addStockModal"];
var _c15 = ["addInventoryModal"];
function InventoryComponent_div_17_div_1_Template(rf, ctx) {
  if (rf & 1) {
    const _r3 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div")(1, "div", 16)(2, "div", 9);
    \u0275\u0275text(3);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(9);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(10, "div", 13)(11, "div", 17);
    \u0275\u0275listener("click", function InventoryComponent_div_17_div_1_Template_div_click_11_listener() {
      const data_r4 = \u0275\u0275restoreView(_r3).$implicit;
      const ctx_r4 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r4.editProduct(data_r4));
    });
    \u0275\u0275text(12, " Add stock ");
    \u0275\u0275elementEnd()()()();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(data_r4.product);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(data_r4.stocks);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(data_r4.category);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(data_r4.brand);
  }
}
function InventoryComponent_div_17_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div");
    \u0275\u0275template(1, InventoryComponent_div_17_div_1_Template, 13, 4, "div", 15);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r4 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275property("ngForOf", ctx_r4.inventory);
  }
}
function InventoryComponent_ng_template_18_Template(rf, ctx) {
  if (rf & 1) {
    const _r6 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 18);
    \u0275\u0275text(1, " Add stocks to");
    \u0275\u0275elementStart(2, "span");
    \u0275\u0275text(3);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(4, "div", 19)(5, "form", 20);
    \u0275\u0275listener("submit", function InventoryComponent_ng_template_18_Template_form_submit_5_listener() {
      \u0275\u0275restoreView(_r6);
      const ctx_r4 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r4.saveEditedProduct());
    });
    \u0275\u0275elementStart(6, "div", 21)(7, "label", 22);
    \u0275\u0275text(8, "Stock:");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(9, "input", 23);
    \u0275\u0275twoWayListener("ngModelChange", function InventoryComponent_ng_template_18_Template_input_ngModelChange_9_listener($event) {
      \u0275\u0275restoreView(_r6);
      const ctx_r4 = \u0275\u0275nextContext();
      \u0275\u0275twoWayBindingSet(ctx_r4.qty, $event) || (ctx_r4.qty = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(10, "div", 24)(11, "button", 25);
    \u0275\u0275listener("click", function InventoryComponent_ng_template_18_Template_button_click_11_listener() {
      \u0275\u0275restoreView(_r6);
      const ctx_r4 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r4.cancelForm());
    });
    \u0275\u0275text(12, "Cancel");
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    const ctx_r4 = \u0275\u0275nextContext();
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(ctx_r4.editingProduct == null ? null : ctx_r4.editingProduct.product);
    \u0275\u0275advance(6);
    \u0275\u0275twoWayProperty("ngModel", ctx_r4.qty);
  }
}
function InventoryComponent_ng_template_20_Template(rf, ctx) {
  if (rf & 1) {
    const _r7 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 18);
    \u0275\u0275text(1, " Add inventory ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(2, "div", 19)(3, "form", 20);
    \u0275\u0275listener("submit", function InventoryComponent_ng_template_20_Template_form_submit_3_listener() {
      \u0275\u0275restoreView(_r7);
      const ctx_r4 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r4.addProduct());
    });
    \u0275\u0275elementStart(4, "label", 27);
    \u0275\u0275text(5, "Product:");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(6, "input", 28);
    \u0275\u0275twoWayListener("ngModelChange", function InventoryComponent_ng_template_20_Template_input_ngModelChange_6_listener($event) {
      \u0275\u0275restoreView(_r7);
      const ctx_r4 = \u0275\u0275nextContext();
      \u0275\u0275twoWayBindingSet(ctx_r4.newInventory.product, $event) || (ctx_r4.newInventory.product = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(7, "label", 29);
    \u0275\u0275text(8, "Category:");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(9, "input", 30);
    \u0275\u0275twoWayListener("ngModelChange", function InventoryComponent_ng_template_20_Template_input_ngModelChange_9_listener($event) {
      \u0275\u0275restoreView(_r7);
      const ctx_r4 = \u0275\u0275nextContext();
      \u0275\u0275twoWayBindingSet(ctx_r4.newInventory.category, $event) || (ctx_r4.newInventory.category = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(10, "label", 31);
    \u0275\u0275text(11, "Brand:");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(12, "input", 32);
    \u0275\u0275twoWayListener("ngModelChange", function InventoryComponent_ng_template_20_Template_input_ngModelChange_12_listener($event) {
      \u0275\u0275restoreView(_r7);
      const ctx_r4 = \u0275\u0275nextContext();
      \u0275\u0275twoWayBindingSet(ctx_r4.newInventory.brand, $event) || (ctx_r4.newInventory.brand = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(13, "label", 33);
    \u0275\u0275text(14, "Stocks:");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(15, "input", 34);
    \u0275\u0275twoWayListener("ngModelChange", function InventoryComponent_ng_template_20_Template_input_ngModelChange_15_listener($event) {
      \u0275\u0275restoreView(_r7);
      const ctx_r4 = \u0275\u0275nextContext();
      \u0275\u0275twoWayBindingSet(ctx_r4.newInventory.stocks, $event) || (ctx_r4.newInventory.stocks = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(16, "div", 24)(17, "button", 25);
    \u0275\u0275listener("click", function InventoryComponent_ng_template_20_Template_button_click_17_listener() {
      \u0275\u0275restoreView(_r7);
      const ctx_r4 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r4.cancelForm());
    });
  ...
  if (rf & 2) {
    const ctx_r4 = \u0275\u0275nextContext();
    \u0275\u0275advance(6);
    \u0275\u0275twoWayProperty("ngModel", ctx_r4.newInventory.product);
    \u0275\u0275advance(3);
    \u0275\u0275twoWayProperty("ngModel", ctx_r4.newInventory.category);
    \u0275\u0275advance(3);
    \u0275\u0275twoWayProperty("ngModel", ctx_r4.newInventory.brand);
    \u0275\u0275advance(3);
    \u0275\u0275twoWayProperty("ngModel", ctx_r4.newInventory.stocks);
  }
}
function InventoryComponent_ng_template_22_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "app-no-data");
  }
}
var _InventoryComponent = class _InventoryComponent {
  constructor(inventoryService, webSocketService, modalService) {
  ...
  openAddInventoryModal(modalContent) {
  ...
  saveEditedProduct() {
    ...
    if (this.editingProduct && this.editingProduct.stocks !== void 0) {
...
_InventoryComponent.\u0275fac = function InventoryComponent_Factory(t) {
  return new (t || _InventoryComponent)(\u0275\u0275directiveInject(InventoryService), \u0275\u0275directiveInject(WebSocketService), \u0275\u0275directiveInject(ModalService));
};
_InventoryComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _InventoryComponent, selectors: [["app-inventory"]], viewQuery: function InventoryComponent_Query(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275viewQuery(_c03, 5);
    \u0275\u0275viewQuery(_c15, 5);
  }
  ...
  if (rf & 1) {
    ...
    \u0275\u0275element(16, "div", 13);
    \u0275\u0275elementEnd();
    \u0275\u0275template(17, InventoryComponent_div_17_Template, 2, 1, "div", 14);
    \u0275\u0275elementEnd()();
    \u0275\u0275template(18, InventoryComponent_ng_template_18_Template, 15, 2, "ng-template", null, 0, \u0275\u0275templateRefExtractor)(20, InventoryComponent_ng_template_20_Template, 21, 4, "ng-template", null, 1, \u0275\u0275templateRefExtractor)(22, InventoryComponent_ng_template_22_Template, 1, 0, "ng-template", null, 2, \u0275\u0275templateRefExtractor);
  }
  if (rf & 2) {
    const noData_r8 = \u0275\u0275reference(23);
    \u0275\u0275advance(17);
    \u0275\u0275property("ngIf", ctx.inventory.length > 0)("ngIfElse", noData_r8);
  }
}, dependencies: [NgForOf, NgIf, \u0275NgNoValidate, DefaultValueAccessor, NumberValueAccessor, NgControlStatus, NgControlStatusGroup, RequiredValidator, NgModel, NgForm, NoDataComponent], styles: ["\n\n@media (max-width: 575.98px) {\n  .inventory[_ngcontent-%COMP%] {\n    padding: 20px;\n  }\n}\n.inventory_title[_ngcontent-%COMP%] {\n  display: flex;\n  justify-content: space-between;\n  font-weight: 700;\n  color: #092C4C;\n  font-size: 18px;\n  margin-bottom: 24px;\n}\n.inventory_title_add[_ngcontent-%COMP%] {\n  background: #FF9F43;\n  cursor: pointer;\n  padding: 8px 11px;\n  color: #ffffff;\n  font-size: 14px;\n  border-radius: 8px;\n}\n.inventory_title_add[_ngcontent-%COMP%]:hover {\n  background: #ffbb00;\n}\n.inventory_table[_ngcontent-%COMP%] {\n  margin-bottom: 1.5rem;\n  background-color: #ffffff;\n  transition: all 0.5s ease-in-out;\n  position: relative;\n  border-radius: 4px;\n  border: 1px solid #dbe0e6;\n  box-shadow: none;\n  padding: 24px;\n}\n@media (max-width: 575.98px) {\n  .inventory_table[_ngcontent-%COMP%] {\n    padding: 15px;\n    display: grid;\n    overflow-x: auto;\n  }\n}\n.inventory_table_header[_ngcontent-%COMP%] {\n  display: flex;\n  justify-content: space-between;\n  padding: 0 24px;\n  padding-bottom: 0.75rem;\n  border-bottom: 1px solid #dbe0e6;\n}\n@media (max-width: 575.98px) {\n  .inventory_table_header[_ngcontent-%COMP%] {\n    padding: 10px;\n  }\n}\n.inventory_table_header[_ngcontent-%COMP%]   div[_ngcontent-%COMP%] {\n  font-weight: 600;\n  font-size: 15px;\n}\n.inventory_table_list[_ngcontent-%COMP%] {\n  display: flex;\n  justify-content: space-between;\n  padding: 24px;\n  color: #092C4C;\n  font-size: 14px;\n  font-weight: 400;\n  line-height: normal;\n  border-bottom: 1px solid #dbe0e6;\n}\n@media (max-width: 575.98px) {\n  .inventory_table_list[_ngcontent-%COMP%] {\n    padding: 10px;\n  }\n}\n.inventory_table_list_add[_ngcontent-%COMP%] {\n  cursor: pointer;\n  border-radius: 3px;\n  text-align: center;\n  padding: 0.25rem 0.5rem;\n  font-size: 0.75rem;\n  background-color: #092C4C !important;\n  border: 1px solid #092C4C !important;\n  color: #ffffff;\n  box-shadow: 0 4px 20px rgba(9, 44, 76, 0.15);\n}\n.inventory_table_list_add[_ngcontent-%COMP%]:hover {\n  background-color: #051a2c !important;\n  border: 1px solid #051a2c !important;\n  box-shadow: 0 3px 10px rgba(9, 44, 76, 0.5);\n}\n.table_one[_ngcontent-%COMP%] {\n  width: 200px;\n}\n.table_two[_ngcontent-%COMP%] {\n  width: 100px;\n}\n.table_three[_ngcontent-%COMP%] {\n  width: 100px;\n}\n.table_four[_ngcontent-%COMP%] {\n  width: 100px;\n}\n.table_five[_ngcontent-%COMP%] {\n  width: 80px;\n}\n.modal-header[_ngcontent-%COMP%] {\n  font-size: 16px;\n  font-weight: 600;\n  color: #1B2850;\n}\n.modal-header[_ngcontent-%COMP%]   span[_ngcontent-%COMP%] {\n  color: #FF9F43;\n  padding-left: 5px;\n}\n.modal-body-label[_ngcontent-%COMP%] {\n  font-size: 14px;\n  color: #5B6670;\n  margin-bottom: 8px;\n  text-transform: capitalize;\n}\n.modal-btns[_ngcontent-%COMP%] {\n  column-gap: 10px;\n  display: flex;\n  justify-content: end;\n  padding: 20px 0;\n  padding-bottom: 0;\n}\n.modal-btns-cancel[_ngcontent-%COMP%] {\n  background: #67748E;\n  color: #ffffff;\n}\n.modal-btns-cancel[_ngcontent-%COMP%]:hover {\n  background: #424b52;\n}\n.modal-btns-add[_ngcontent-%COMP%] {\n  background: #FF9F43;\n  color: #ffffff;\n}\n.modal-btns-add[_ngcontent-%COMP%]:hover {\n  background: #ffbb00;\n}\n.btn[_ngcontent-%COMP%] {\n  border-radius: 3px;\n  padding: 0.625rem 1.25rem;\n  padding: 0.5rem 0.85rem;\n  font-size: 0.85rem;\n  transition: all 0.5s;\n}\ninput[_ngcontent-%COMP%] {\n  border-color: #e9edf6;\n  color: #5B6670;\n  font-size: 0.875rem;\n  line-height: 1.6;\n  padding: 0.5rem 0.85rem;\n  margin-bottom: 1rem;\n}\n[_ngcontent-%COMP%]::placeholder {\n  color: #8b949b;\n}\n/*# sourceMappingURL=inventory.component.css.map */"] });
...
_ProductService.\u0275fac = function ProductService_Factory(t) {
  return new (t || _ProductService)(\u0275\u0275inject(HttpClient), \u0275\u0275inject(WebSocketService));
};
...
var _c04 = ["editProductModal"];
var _c16 = ["addProductModal"];
function ProductsComponent_div_13_div_1_Template(rf, ctx) {
  if (rf & 1) {
    const _r2 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 14)(1, "div", 9);
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "div", 10);
    \u0275\u0275text(4);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "div", 11)(6, "div", 15);
    \u0275\u0275listener("click", function ProductsComponent_div_13_div_1_Template_div_click_6_listener() {
      const data_r3 = \u0275\u0275restoreView(_r2).$implicit;
      const ctx_r3 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r3.editProduct(data_r3));
    });
    \u0275\u0275text(7, " Edit ");
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", data_r3.product, " ");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" PHP ", data_r3.price, " ");
  }
}
function ProductsComponent_div_13_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div");
    \u0275\u0275template(1, ProductsComponent_div_13_div_1_Template, 8, 2, "div", 13);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r3 = \u0275\u0275nextContext();
...
function ProductsComponent_ng_template_14_div_0_Template(rf, ctx) {
  if (rf & 1) {
    const _r5 = \u0275\u0275getCurrentView();
    ...
    \u0275\u0275listener("submit", function ProductsComponent_ng_template_14_div_0_Template_form_submit_6_listener() {
      \u0275\u0275restoreView(_r5);
      const ctx_r3 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r3.saveEditedProduct());
    });
    \u0275\u0275elementStart(7, "div", 20)(8, "label", 21);
    \u0275\u0275text(9, "Price:");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(10, "input", 22);
    \u0275\u0275twoWayListener("ngModelChange", function ProductsComponent_ng_template_14_div_0_Template_input_ngModelChange_10_listener($event) {
      \u0275\u0275restoreView(_r5);
      const ctx_r3 = \u0275\u0275nextContext(2);
      \u0275\u0275twoWayBindingSet(ctx_r3.editingProduct.price, $event) || (ctx_r3.editingProduct.price = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(11, "div", 23)(12, "button", 24);
    \u0275\u0275listener("click", function ProductsComponent_ng_template_14_div_0_Template_button_click_12_listener() {
      \u0275\u0275restoreView(_r5);
      const ctx_r3 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r3.cancelForm());
    });
    \u0275\u0275text(13, "Cancel");
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    const ctx_r3 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate(ctx_r3.editingProduct == null ? null : ctx_r3.editingProduct.product);
    \u0275\u0275advance(6);
    \u0275\u0275twoWayProperty("ngModel", ctx_r3.editingProduct.price);
  }
}
function ProductsComponent_ng_template_14_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275template(0, ProductsComponent_ng_template_14_div_0_Template, 16, 2, "div", 16);
  }
  if (rf & 2) {
    const ctx_r3 = \u0275\u0275nextContext();
    \u0275\u0275property("ngIf", ctx_r3.editingProduct);
  }
}
function ProductsComponent_ng_template_16_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(1, " Add drink ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(2, "div")(3, "div", 18)(4, "form", 19);
    \u0275\u0275listener("submit", function ProductsComponent_ng_template_16_Template_form_submit_4_listener() {
      \u0275\u0275restoreView(_r6);
      const ctx_r3 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r3.addProduct());
    });
    \u0275\u0275elementStart(5, "label", 26);
    \u0275\u0275text(6, "Product:");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(7, "input", 27);
    \u0275\u0275twoWayListener("ngModelChange", function ProductsComponent_ng_template_16_Template_input_ngModelChange_7_listener($event) {
      \u0275\u0275restoreView(_r6);
      const ctx_r3 = \u0275\u0275nextContext();
      \u0275\u0275twoWayBindingSet(ctx_r3.newProduct.product, $event) || (ctx_r3.newProduct.product = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(8, "label", 28);
    \u0275\u0275text(9, "Price:");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(10, "input", 29);
    \u0275\u0275twoWayListener("ngModelChange", function ProductsComponent_ng_template_16_Template_input_ngModelChange_10_listener($event) {
      \u0275\u0275restoreView(_r6);
      const ctx_r3 = \u0275\u0275nextContext();
      \u0275\u0275twoWayBindingSet(ctx_r3.newProduct.price, $event) || (ctx_r3.newProduct.price = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(11, "div", 23)(12, "button", 24);
    \u0275\u0275listener("click", function ProductsComponent_ng_template_16_Template_button_click_12_listener() {
      \u0275\u0275restoreView(_r6);
      const ctx_r3 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r3.cancelForm());
    });
  ...
  if (rf & 2) {
    const ctx_r3 = \u0275\u0275nextContext();
    \u0275\u0275advance(7);
    \u0275\u0275twoWayProperty("ngModel", ctx_r3.newProduct.product);
    \u0275\u0275advance(3);
    \u0275\u0275twoWayProperty("ngModel", ctx_r3.newProduct.price);
  }
}
function ProductsComponent_ng_template_18_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "app-no-data");
  }
}
var _ProductsComponent = class _ProductsComponent {
  constructor(modalService, productService, webSocketService) {
    this.modalService = modalService;
...
_ProductsComponent.\u0275fac = function ProductsComponent_Factory(t) {
  return new (t || _ProductsComponent)(\u0275\u0275directiveInject(ModalService), \u0275\u0275directiveInject(ProductService), \u0275\u0275directiveInject(WebSocketService));
};
_ProductsComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ProductsComponent, selectors: [["app-products"]], viewQuery: function ProductsComponent_Query(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275viewQuery(_c04, 5);
    \u0275\u0275viewQuery(_c16, 5);
  }
  ...
  if (rf & 1) {
    ...
    \u0275\u0275element(12, "div", 11);
    \u0275\u0275elementEnd();
    \u0275\u0275template(13, ProductsComponent_div_13_Template, 2, 1, "div", 12);
    \u0275\u0275elementEnd()();
    \u0275\u0275template(14, ProductsComponent_ng_template_14_Template, 1, 1, "ng-template", null, 0, \u0275\u0275templateRefExtractor)(16, ProductsComponent_ng_template_16_Template, 16, 2, "ng-template", null, 1, \u0275\u0275templateRefExtractor)(18, ProductsComponent_ng_template_18_Template, 1, 0, "ng-template", null, 2, \u0275\u0275templateRefExtractor);
  }
  if (rf & 2) {
    const noData_r7 = \u0275\u0275reference(19);
    \u0275\u0275advance(13);
    \u0275\u0275property("ngIf", ctx.products.length > 0)("ngIfElse", noData_r7);
  }
}, dependencies: [NgForOf, NgIf, \u0275NgNoValidate, DefaultValueAccessor, NumberValueAccessor, NgControlStatus, NgControlStatusGroup, RequiredValidator, NgModel, NgForm, NoDataComponent], styles: ["\n\n@media (max-width: 575.98px) {\n  .products[_ngcontent-%COMP%] {\n    padding: 20px;\n  }\n}\n.products_title[_ngcontent-%COMP%] {\n  display: flex;\n  justify-content: space-between;\n  font-weight: 700;\n  color: #092C4C;\n  font-size: 18px;\n  margin-bottom: 24px;\n}\n.products_title_add[_ngcontent-%COMP%] {\n  background: #FF9F43;\n  cursor: pointer;\n  padding: 8px 11px;\n  color: #ffffff;\n  font-size: 14px;\n  border-radius: 8px;\n}\n.products_title_add[_ngcontent-%COMP%]:hover {\n  background: #ffbb00;\n}\n.products_table[_ngcontent-%COMP%] {\n  margin-bottom: 1.5rem;\n  background-color: #ffffff;\n  transition: all 0.5s ease-in-out;\n  position: relative;\n  border-radius: 4px;\n  border: 1px solid #dbe0e6;\n  box-shadow: none;\n  padding: 24px;\n}\n@media (max-width: 575.98px) {\n  .products_table[_ngcontent-%COMP%] {\n    padding: 15px;\n    display: grid;\n    overflow-x: auto;\n  }\n}\n.products_table_header[_ngcontent-%COMP%] {\n  display: flex;\n  justify-content: space-between;\n  padding: 0 24px;\n  padding-bottom: 0.75rem;\n  border-bottom: 1px solid #dbe0e6;\n}\n.products_table_header[_ngcontent-%COMP%]   div[_ngcontent-%COMP%] {\n  font-weight: 600;\n  font-size: 15px;\n}\n.products_table_list[_ngcontent-%COMP%] {\n  display: flex;\n  justify-content: space-between;\n  padding: 24px;\n  color: #092C4C;\n  font-size: 14px;\n  font-weight: 400;\n  line-height: normal;\n  border-bottom: 1px solid #dbe0e6;\n}\n.products_table_list_add[_ngcontent-%COMP%] {\n  cursor: pointer;\n  border-radius: 3px;\n  text-align: center;\n  padding: 0.25rem 0.5rem;\n  font-size: 0.75rem;\n  background-color: #092C4C !important;\n  border: 1px solid #092C4C !important;\n  color: #ffffff;\n  box-shadow: 0 4px 20px rgba(9, 44, 76, 0.15);\n}\n.products_table_list_add[_ngcontent-%COMP%]:hover {\n  background-color: #051a2c !important;\n  border: 1px solid #051a2c !important;\n  box-shadow: 0 3px 10px rgba(9, 44, 76, 0.5);\n}\n.table_one[_ngcontent-%COMP%] {\n  width: 200px;\n}\n.table_two[_ngcontent-%COMP%] {\n  width: 100px;\n}\n.table_three[_ngcontent-%COMP%] {\n  width: 100px;\n}\n.table_four[_ngcontent-%COMP%] {\n  width: 100px;\n}\n.table_five[_ngcontent-%COMP%] {\n  width: 80px;\n}\n.modal-header[_ngcontent-%COMP%] {\n  font-size: 16px;\n  font-weight: 600;\n  color: #1B2850;\n}\n.modal-header[_ngcontent-%COMP%]   span[_ngcontent-%COMP%] {\n  color: #FF9F43;\n  padding-left: 5px;\n}\n.modal-body-label[_ngcontent-%COMP%] {\n  font-size: 14px;\n  color: #5B6670;\n  margin-bottom: 8px;\n  text-transform: capitalize;\n}\n.modal-btns[_ngcontent-%COMP%] {\n  column-gap: 10px;\n  display: flex;\n  justify-content: end;\n  padding: 20px 0;\n  padding-bottom: 0;\n}\n.modal-btns-cancel[_ngcontent-%COMP%] {\n  background: #67748E;\n  color: #ffffff;\n}\n.modal-btns-cancel[_ngcontent-%COMP%]:hover {\n  background: #424b52;\n}\n.modal-btns-add[_ngcontent-%COMP%] {\n  background: #FF9F43;\n  color: #ffffff;\n}\n.modal-btns-add[_ngcontent-%COMP%]:hover {\n  background: #ffbb00;\n}\n.btn[_ngcontent-%COMP%] {\n  border-radius: 3px;\n  padding: 0.625rem 1.25rem;\n  padding: 0.5rem 0.85rem;\n  font-size: 0.85rem;\n  transition: all 0.5s;\n}\ninput[_ngcontent-%COMP%] {\n  border-color: #e9edf6;\n  color: #5B6670;\n  font-size: 0.875rem;\n  line-height: 1.6;\n  padding: 0.5rem 0.85rem;\n  margin-bottom: 1rem;\n}\n[_ngcontent-%COMP%]::placeholder {\n  color: #8b949b;\n}\n/*# sourceMappingURL=products.component.css.map */"] });
...
var _AppService = class _AppService {
  ...
  putStocks(id, payload) {
    return this.http.put(this.API_URL + `inventory/add-stocks/${id}`, payload);
  }
  postInventory(payload) {
    return this.http.post(this.API_URL + "inventory", payload);
  }
  getProducts() {
    return this.http.get(this.API_URL + "products");
  }
  postProduct(payload) {
    return this.http.post(this.API_URL + `products`, payload);
  }
  ...
  postExpense(payload) {
    return this.http.post(this.API_URL + "expenses", payload);
  }
};
_AppService.\u0275fac = function AppService_Factory(t) {
  return new (t || _AppService)(\u0275\u0275inject(HttpClient));
};
...
// src/app/admin/expenses/expenses.component.ts
function ExpensesComponent_div_18_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    const data_r3 = ctx.$implicit;
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", data_r3.expense, " ");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", data_r3.month, " ");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(7, 5, data_r3.date, "EEEE, MMMM d, y, h:mm:ss a zzzz"), " ");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" PHP ", data_r3.amount, " ");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", data_r3.channel, " ");
  }
}
function ExpensesComponent_ng_template_19_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(1, " Add expense ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(2, "div", 15)(3, "form", 16);
    \u0275\u0275listener("submit", function ExpensesComponent_ng_template_19_Template_form_submit_3_listener() {
      \u0275\u0275restoreView(_r4);
      const ctx_r4 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r4.addProduct());
    });
    ...
    \u0275\u0275twoWayListener("ngModelChange", function ExpensesComponent_ng_template_19_Template_input_ngModelChange_6_listener($event) {
      \u0275\u0275restoreView(_r4);
      const ctx_r4 = \u0275\u0275nextContext();
      \u0275\u0275twoWayBindingSet(ctx_r4.newExpenses.expense, $event) || (ctx_r4.newExpenses.expense = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275twoWayListener("ngModelChange", function ExpensesComponent_ng_template_19_Template_input_ngModelChange_9_listener($event) {
      \u0275\u0275restoreView(_r4);
      const ctx_r4 = \u0275\u0275nextContext();
      \u0275\u0275twoWayBindingSet(ctx_r4.newExpenses.amount, $event) || (ctx_r4.newExpenses.amount = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275twoWayListener("ngModelChange", function ExpensesComponent_ng_template_19_Template_input_ngModelChange_12_listener($event) {
      \u0275\u0275restoreView(_r4);
      const ctx_r4 = \u0275\u0275nextContext();
      \u0275\u0275twoWayBindingSet(ctx_r4.newExpenses.channel, $event) || (ctx_r4.newExpenses.channel = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275listener("click", function ExpensesComponent_ng_template_19_Template_button_click_16_listener() {
      \u0275\u0275restoreView(_r4);
      const ctx_r4 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r4.cancelForm());
    });
  ...
  if (rf & 2) {
    const ctx_r4 = \u0275\u0275nextContext();
    \u0275\u0275advance(6);
    \u0275\u0275twoWayProperty("ngModel", ctx_r4.newExpenses.expense);
    \u0275\u0275advance(3);
    \u0275\u0275twoWayProperty("ngModel", ctx_r4.newExpenses.amount);
    \u0275\u0275advance(3);
    \u0275\u0275twoWayProperty("ngModel", ctx_r4.newExpenses.channel);
  }
}
var _ExpensesComponent = class _ExpensesComponent {
  constructor(appService, modalService, expensesService, webSocketService) {
...
_ExpensesComponent.\u0275fac = function ExpensesComponent_Factory(t) {
  return new (t || _ExpensesComponent)(\u0275\u0275directiveInject(AppService), \u0275\u0275directiveInject(ModalService), \u0275\u0275directiveInject(ExpensesService), \u0275\u0275directiveInject(WebSocketService));
};
_ExpensesComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ExpensesComponent, selectors: [["app-expenses"]], decls: 21, vars: 1, consts: [["addInventoryModal", ""], [1, "inventory"], [1, "inventory_title"], [1, "inventory_title_add", 3, "click"], [1, "inventory_table"], [1, "inventory_table_filter"], [1, "inventory_table_header"], [1, "table_one"], [1, "table_two"], [1, "table_three"], [1, "table_four"], [1, "table_five"], ["class", "inventory_table_list", 4, "ngFor", "ngForOf"], [1, "inventory_table_list"], [1, "modal-header"], [1, "modal-body"], [3, "submit"], ["for", "productName", 1, "modal-body-label"], ["type", "text", "id", "productName", "name", "productName", "required", "", 1, "form-control", 3, "ngModelChange", "ngModel"], ["for", "categoryName", 1, "modal-body-label"], ["type", "number", "id", "categoryName", "name", "categoryName", "required", "", 1, "form-control", 3, "ngModelChange", "ngModel"], ["for", "brandName", 1, "modal-body-label"], ["type", "text", "id", "brandName", "name", "brandName", "required", "", 1, "form-control", 3, "ngModelChange", "ngModel"], ["for", "productStocks", 1, "modal-body-label"], [1, "modal-btns"], ["type", "button", 1, "btn", "modal-btns-cancel", 3, "click"], ["type", "submit", 1, "btn", "modal-btns-add"]], template: function ExpensesComponent_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 1)(1, "div", 2);
    \u0275\u0275text(2, " Expenses ");
    \u0275\u0275elementStart(3, "div", 3);
    \u0275\u0275listener("click", function ExpensesComponent_Template_div_click_3_listener() {
      \u0275\u0275restoreView(_r1);
      const addInventoryModal_r2 = \u0275\u0275reference(20);
      return \u0275\u0275resetView(ctx.openAddInventoryModal(addInventoryModal_r2));
    });
    ...
    \u0275\u0275text(17, "Channel");
    \u0275\u0275elementEnd()();
    \u0275\u0275template(18, ExpensesComponent_div_18_Template, 12, 8, "div", 12);
    \u0275\u0275elementEnd()();
    \u0275\u0275template(19, ExpensesComponent_ng_template_19_Template, 20, 3, "ng-template", null, 0, \u0275\u0275templateRefExtractor);
  }
  if (rf & 2) {
    \u0275\u0275advance(18);
    \u0275\u0275property("ngForOf", ctx.expenses);
  }
}, dependencies: [NgForOf, \u0275NgNoValidate, DefaultValueAccessor, NumberValueAccessor, NgControlStatus, NgControlStatusGroup, RequiredValidator, NgModel, NgForm, DatePipe], styles: ["\n\n@media (max-width: 575.98px) {\n  .inventory[_ngcontent-%COMP%] {\n    padding: 20px;\n  }\n}\n.inventory_title[_ngcontent-%COMP%] {\n  display: flex;\n  justify-content: space-between;\n  font-weight: 700;\n  color: #092C4C;\n  font-size: 18px;\n  margin-bottom: 24px;\n}\n.inventory_title_add[_ngcontent-%COMP%] {\n  background: #FF9F43;\n  cursor: pointer;\n  padding: 8px 11px;\n  color: #ffffff;\n  font-size: 14px;\n  border-radius: 8px;\n}\n.inventory_title_add[_ngcontent-%COMP%]:hover {\n  background: #ffbb00;\n}\n.inventory_table[_ngcontent-%COMP%] {\n  margin-bottom: 1.5rem;\n  background-color: #ffffff;\n  transition: all 0.5s ease-in-out;\n  position: relative;\n  border-radius: 4px;\n  border: 1px solid #dbe0e6;\n  box-shadow: none;\n  padding: 24px;\n}\n@media (max-width: 575.98px) {\n  .inventory_table[_ngcontent-%COMP%] {\n    padding: 15px;\n    display: grid;\n    overflow-x: auto;\n  }\n}\n.inventory_table_header[_ngcontent-%COMP%] {\n  display: flex;\n  justify-content: space-between;\n  padding: 0 24px;\n  padding-bottom: 0.75rem;\n  border-bottom: 1px solid #dbe0e6;\n}\n.inventory_table_header[_ngcontent-%COMP%]   div[_ngcontent-%COMP%] {\n  font-weight: 600;\n  font-size: 15px;\n}\n.inventory_table_list[_ngcontent-%COMP%] {\n  display: flex;\n  justify-content: space-between;\n  padding: 24px;\n  color: #092C4C;\n  font-size: 14px;\n  font-weight: 400;\n  line-height: normal;\n  border-bottom: 1px solid #dbe0e6;\n}\n.inventory_table_list_add[_ngcontent-%COMP%]:hover {\n  background-color: #051a2c !important;\n  border: 1px solid #051a2c !important;\n  box-shadow: 0 3px 10px rgba(9, 44, 76, 0.5);\n}\n.table_one[_ngcontent-%COMP%] {\n  width: 200px;\n}\n.table_two[_ngcontent-%COMP%] {\n  width: 100px;\n}\n.table_three[_ngcontent-%COMP%] {\n  width: 100px;\n}\n.table_four[_ngcontent-%COMP%] {\n  width: 100px;\n}\n.table_five[_ngcontent-%COMP%] {\n  width: 80px;\n}\n.modal-header[_ngcontent-%COMP%] {\n  font-size: 16px;\n  font-weight: 600;\n  color: #1B2850;\n}\n.modal-header[_ngcontent-%COMP%]   span[_ngcontent-%COMP%] {\n  color: #FF9F43;\n  padding-left: 5px;\n}\n.modal-body-label[_ngcontent-%COMP%] {\n  font-size: 14px;\n  color: #5B6670;\n  margin-bottom: 8px;\n  text-transform: capitalize;\n}\n.modal-btns[_ngcontent-%COMP%] {\n  column-gap: 10px;\n  display: flex;\n  justify-content: end;\n  padding: 20px 0;\n  padding-bottom: 0;\n}\n.modal-btns-cancel[_ngcontent-%COMP%] {\n  background: #67748E;\n  color: #ffffff;\n}\n.modal-btns-cancel[_ngcontent-%COMP%]:hover {\n  background: #424b52;\n}\n.modal-btns-add[_ngcontent-%COMP%] {\n  background: #FF9F43;\n  color: #ffffff;\n}\n.modal-btns-add[_ngcontent-%COMP%]:hover {\n  background: #ffbb00;\n}\n.btn[_ngcontent-%COMP%] {\n  border-radius: 3px;\n  padding: 0.625rem 1.25rem;\n  padding: 0.5rem 0.85rem;\n  font-size: 0.85rem;\n  transition: all 0.5s;\n}\ninput[_ngcontent-%COMP%] {\n  border-color: #e9edf6;\n  color: #5B6670;\n  font-size: 0.875rem;\n  line-height: 1.6;\n  padding: 0.5rem 0.85rem;\n  margin-bottom: 1rem;\n}\n[_ngcontent-%COMP%]::placeholder {\n  color: #8b949b;\n}\n/*# sourceMappingURL=expenses.component.css.map */"] });
...
function PosComponent_div_2_div_1_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    ...
    \u0275\u0275listener("click", function PosComponent_div_2_div_1_Template_button_click_5_listener() {
      const product_r2 = \u0275\u0275restoreView(_r1).$implicit;
      const ctx_r2 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r2.addToRightDiv(product_r2));
    });
    \u0275\u0275text(6, "Add");
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", product_r2.product, " ");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1("PHP ", product_r2.price, "");
  }
}
function PosComponent_div_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 14);
    \u0275\u0275template(1, PosComponent_div_2_div_1_Template, 7, 2, "div", 15);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
...
function PosComponent_div_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div");
...
function PosComponent_div_7_Template(rf, ctx) {
  if (rf & 1) {
    const _r4 = \u0275\u0275getCurrentView();
    ...
    \u0275\u0275listener("click", function PosComponent_div_7_Template_svg_click_7_listener() {
      const selectedProduct_r5 = \u0275\u0275restoreView(_r4).$implicit;
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.decrementCounter(selectedProduct_r5));
    });
    \u0275\u0275element(8, "path", 25);
    \u0275\u0275elementEnd();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(9, "input", 26);
    \u0275\u0275twoWayListener("ngModelChange", function PosComponent_div_7_Template_input_ngModelChange_9_listener($event) {
      const selectedProduct_r5 = \u0275\u0275restoreView(_r4).$implicit;
      \u0275\u0275twoWayBindingSet(selectedProduct_r5.counter, $event) || (selectedProduct_r5.counter = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275listener("ngModelChange", function PosComponent_div_7_Template_input_ngModelChange_9_listener() {
      \u0275\u0275restoreView(_r4);
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.updateOverallTotal());
    });
    \u0275\u0275elementEnd();
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(10, "svg", 24);
    \u0275\u0275listener("click", function PosComponent_div_7_Template_svg_click_10_listener() {
      const selectedProduct_r5 = \u0275\u0275restoreView(_r4).$implicit;
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.incrementCounter(selectedProduct_r5));
    });
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(14, "svg", 29);
    \u0275\u0275listener("click", function PosComponent_div_7_Template_svg_click_14_listener() {
      const i_r6 = \u0275\u0275restoreView(_r4).index;
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.deleteProduct(i_r6));
    });
    \u0275\u0275element(15, "path", 30);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    const selectedProduct_r5 = ctx.$implicit;
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(selectedProduct_r5.product);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1("PHP ", selectedProduct_r5.price, "");
    \u0275\u0275advance(4);
    \u0275\u0275twoWayProperty("ngModel", selectedProduct_r5.counter);
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1("PHP ", selectedProduct_r5.price * selectedProduct_r5.counter, "");
  }
}
var _PosComponent = class _PosComponent {
  ...
  ngOnInit() {
    this.productService.products$.subscribe((products) => {
      if (products && products.length > 0) {
        this.products = products.map((product) => __spreadProps(__spreadValues({}, product), { counter: 0 }));
      }
    });
  }
  addToRightDiv(product) {
  ...
  incrementCounter(selectedProduct) {
    selectedProduct.counter++;
    this.calculateOverallTotal();
  }
  decrementCounter(selectedProduct) {
  ...
  clearSelectedProducts() {
    ...
    console.log("data", orders, this.totalQuantity, this.overallTotal, transactionId, (/* @__PURE__ */ new Date()).toISOString());
    const orderSummary = {
      orders,
  ...
  addToSales(transactionSales) {
    console.log("sale", transactionSales);
    this.salesService.addSales(transactionSales);
  }
  generateTransactionId() {
    const randomNumber = Math.floor(Math.random() * 9e4) + 1e4;
    const timestamp = (/* @__PURE__ */ new Date()).getTime();
    const transactionId = `TRX-${timestamp}-${randomNumber}`;
    return transactionId;
  }
};
_PosComponent.\u0275fac = function PosComponent_Factory(t) {
  return new (t || _PosComponent)(\u0275\u0275directiveInject(ProductService), \u0275\u0275directiveInject(SalesService));
};
_PosComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _PosComponent, selectors: [["app-pos"]], decls: 21, vars: 7, consts: [[1, "pos"], ["class", "pos_card", 4, "ngIf"], [4, "ngIf"], [1, "pos_selected"], [1, "pos_selected_orders"], ["class", "pos_selected_product", 4, "ngFor", "ngForOf"], [1, "pos_selected_total"], [1, "pos_selected_total_qty"], [1, "pos_selected_total_qty_text"], [1, "pos_selected_total_qty_qty"], [1, "pos_selected_total_amount"], [1, "pos_selected_total_amount_text"], [1, "pos_selected_total_amount_amount"], [1, "pos_selected_next", 3, "click"], [1, "pos_card"], ["class", "pos_card_drink", 4, "ngFor", "ngForOf"], [1, "pos_card_drink"], [1, "pos_card_price"], [3, "click"], [1, "pos_selected_product"], [1, "pos_selected_product_info"], [1, "pos_selected_product_info_product"], [1, "pos_selected_product_info_price"], [1, "pos_selected_product_info_qty"], ["xmlns", "http://www.w3.org/2000/svg", "viewBox", "0 0 24 24", "fill", "currentColor", 3, "click"], ["d", "M19 11H5V13H19V11Z"], ["type", "number", "min", "0", 1, "form-control", 3, "ngModelChange", "ngModel"], ["d", "M11 11V5H13V11H19V13H13V19H11V13H5V11H11Z"], [1, "pos_selected_product_info_total"], ["xmlns", "http://www.w3.org/2000/svg", "viewBox", "0 0 24 24", "fill", "currentColor", 1, "pos_selected_product_info_delete", 3, "click"], ["d", "M17 6H22V8H20V21C20 21.5523 19.5523 22 19 22H5C4.44772 22 4 21.5523 4 21V8H2V6H7V3C7 2.44772 7.44772 2 8 2H16C16.5523 2 17 2.44772 17 3V6ZM18 8H6V20H18V8ZM9 11H11V17H9V11ZM13 11H15V17H13V11ZM9 4V6H15V4H9Z"]], template: function PosComponent_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 0)(1, "div");
    \u0275\u0275template(2, PosComponent_div_2_Template, 2, 1, "div", 1)(3, PosComponent_div_3_Template, 2, 0, "div", 2);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "div", 3)(5, "div", 4);
    \u0275\u0275text(6, "Orders");
    \u0275\u0275elementEnd();
    \u0275\u0275template(7, PosComponent_div_7_Template, 16, 4, "div", 5);
    ...
    \u0275\u0275listener("click", function PosComponent_Template_div_click_19_listener() {
      return ctx.clearSelectedProducts();
    });
    \u0275\u0275text(20, "Next Order");
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    \u0275\u0275advance(2);
    \u0275\u0275property("ngIf", ctx.products && ctx.products.length);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", !ctx.products || ctx.products.length === 0);
    \u0275\u0275advance(4);
    \u0275\u0275property("ngForOf", ctx.selectedProducts);
    \u0275\u0275advance(6);
    \u0275\u0275textInterpolate(ctx.totalQuantity);
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate1("PHP ", ctx.overallTotal, "");
    \u0275\u0275advance();
    \u0275\u0275classProp("disable", ctx.selectedProducts.length === 0);
  }
}, dependencies: [NgForOf, NgIf, DefaultValueAccessor, NumberValueAccessor, NgControlStatus, MinValidator, NgModel], styles: ["\n\n.pos[_ngcontent-%COMP%] {\n  height: 100vh;\n  padding: 24px;\n  display: flex;\n  column-gap: 40px;\n  background-color: #f8f9fa;\n}\n.pos_card[_ngcontent-%COMP%] {\n  display: grid;\n  column-gap: 40px;\n  grid-template-columns: repeat(4, 1fr);\n}\n.pos_card_drink[_ngcontent-%COMP%] {\n  display: flex;\n  flex-direction: column;\n  justify-content: center;\n  width: 200px;\n  height: 200px;\n  font-size: 22px;\n  font-weight: bold;\n  padding: 15px;\n  -webkit-transition: all 0.5s ease;\n  -ms-transition: all 0.5s ease;\n  transition: all 0.5s ease;\n  margin-bottom: 1.5rem;\n  background-color: #ffffff;\n  transition: all 0.5s ease-in-out;\n  position: relative;\n  border-radius: 4px;\n  border: 1px solid #dbe0e6;\n  box-shadow: none;\n  text-align: center;\n}\n.pos_card_price[_ngcontent-%COMP%] {\n  font-size: 18px;\n  font-weight: normal;\n}\n.pos_selected[_ngcontent-%COMP%] {\n  width: 100%;\n  height: fit-content;\n  padding: 24px;\n  background-color: #ffffff;\n  border-left: 1px solid #f3f6f9;\n}\n.pos_selected_orders[_ngcontent-%COMP%] {\n  font-size: 16px;\n  font-weight: 600;\n  margin-bottom: 20px;\n  color: #1B2850;\n}\n.pos_selected_product[_ngcontent-%COMP%] {\n  box-shadow: 0px 4px 60px 0px rgba(231, 231, 231, 0.47);\n  margin: 0 0 10px 0;\n  padding: 10px;\n}\n.pos_selected_product_info[_ngcontent-%COMP%] {\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n}\n.pos_selected_product_info_product[_ngcontent-%COMP%] {\n  width: 115px;\n  color: #092C4C;\n  font-weight: 600;\n}\n.pos_selected_product_info_qty[_ngcontent-%COMP%] {\n  width: 110px;\n  display: flex;\n  align-items: center;\n  column-gap: 5px;\n}\n.pos_selected_product_info_qty_price[_ngcontent-%COMP%] {\n  width: 60px;\n}\n.pos_selected_product_info_qty[_ngcontent-%COMP%]   input[_ngcontent-%COMP%] {\n  padding: 1px 9px;\n  background: #FAFBFE;\n  border-radius: 8px;\n  height: 28px;\n  width: 71px;\n  text-align: center;\n  font-size: 14px;\n  border: 1px solid #e9edf6;\n  color: #5B6670;\n}\n.pos_selected_product_info_qty[_ngcontent-%COMP%]   svg[_ngcontent-%COMP%] {\n  width: 14px;\n  height: 14px;\n  border-radius: 50px;\n  border: 1px solid #082c4c;\n  fill: #082c4c;\n  cursor: pointer;\n}\n.pos_selected_product_info_qty_total[_ngcontent-%COMP%] {\n  width: 65;\n}\n.pos_selected_product_info_delete[_ngcontent-%COMP%] {\n  width: 14px;\n  height: 14px;\n  fill: #f00;\n  cursor: pointer;\n}\n.pos_selected_total[_ngcontent-%COMP%] {\n  color: #5B6670;\n  background-color: #f3f6f9;\n  padding: 10px;\n  border-radius: 8px;\n}\n.pos_selected_total_qty[_ngcontent-%COMP%] {\n  display: flex;\n  border-bottom: 1px dashed #dbe0e6;\n  padding-bottom: 10px;\n}\n.pos_selected_total_qty_text[_ngcontent-%COMP%] {\n  width: 300px;\n}\n.pos_selected_total_qty_qty[_ngcontent-%COMP%] {\n  width: 100px;\n  text-align: right;\n}\n.pos_selected_total_amount[_ngcontent-%COMP%] {\n  display: flex;\n  padding-top: 10px;\n}\n.pos_selected_total_amount_text[_ngcontent-%COMP%] {\n  width: 300px;\n}\n.pos_selected_total_amount_amount[_ngcontent-%COMP%] {\n  width: 100px;\n  font-weight: 600;\n  text-align: right;\n}\n.pos_selected_next[_ngcontent-%COMP%] {\n  background-color: #28C76F;\n  border: 1px solid #28C76F;\n  color: #ffffff;\n  cursor: pointer;\n  text-align: center;\n  border-radius: 4px;\n  font-size: 14px;\n  padding: 10px;\n  margin-top: 20px;\n  box-shadow: 0 4px 20px rgba(40, 199, 111, 0.15);\n}\n.pos_selected_next[_ngcontent-%COMP%]:hover {\n  background-color: #22a95e;\n  border: 1px solid #22a95e;\n  box-shadow: 0 3px 10px rgba(40, 199, 111, 0.5);\n}\n.disable[_ngcontent-%COMP%], .disable[_ngcontent-%COMP%]:hover {\n  background-color: #BFEED4;\n  color: #28C76F;\n  cursor: not-allowed;\n  border: none;\n  box-shadow: none;\n}\n/*# sourceMappingURL=pos.component.css.map */"] });
var PosComponent = _PosComponent;
(() => {
...
_SidebarComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SidebarComponent, selectors: [["app-sidebar"]], decls: 29, vars: 0, consts: [[1, "sidebar"], [1, "sidebar_header"], ["src", "assets/img/logo.png"], [1, "sidebar_nav"], ["routerLink", "/admin/dashboard", "routerLinkActive", "active", "routerDirection", "root", 1, "sidebar_nav_menu"], ["xmlns", "http://www.w3.org/2000/svg", "viewBox", "0 0 24 24", "fill", "currentColor"], ["d", "M21 20C21 20.5523 20.5523 21 20 21H4C3.44772 21 3 20.5523 3 20V9.48907C3 9.18048 3.14247 8.88917 3.38606 8.69972L11.3861 2.47749C11.7472 2.19663 12.2528 2.19663 12.6139 2.47749L20.6139 8.69972C20.8575 8.88917 21 9.18048 21 9.48907V20ZM19 19V9.97815L12 4.53371L5 9.97815V19H19Z"], ["routerLink", "/admin/inventory", "routerLinkActive", "active", "routerDirection", "root", 1, "sidebar_nav_menu"], ["d", "M12 1L21.5 6.5V17.5L12 23L2.5 17.5V6.5L12 1ZM5.49388 7.0777L12.0001 10.8444L18.5062 7.07774L12 3.311L5.49388 7.0777ZM4.5 8.81329V16.3469L11.0001 20.1101V12.5765L4.5 8.81329ZM13.0001 20.11L19.5 16.3469V8.81337L13.0001 12.5765V20.11Z"], ["routerLink", "/admin/products", "routerLinkActive", "active", "routerDirection", "root", 1, "sidebar_nav_menu"], ["d", "M14 2H6.20495C5.6091 2 5.09608 2.42057 4.97923 3.00485L4.1802 7H2V9H4.10875L5.48105 20.8933C5.55383 21.524 6.08789 22 6.72281 22H17.2772C17.9121 22 18.4462 21.524 18.5189 20.8933L19.8912 9H22V7H19.8198L19.0208 3.00485C18.9039 2.42057 18.3909 2 17.795 2H16V0H14V2ZM17.7802 7H6.2198L6.8198 4H17.1802L17.7802 7ZM6.12202 9H17.878L16.6088 20H7.39125L6.12202 9Z"], ["routerLink", "/admin/sales", "routerLinkActive", "active", "routerDirection", "root", 1, "sidebar_nav_menu"], ["d", "M11 7H13V17H11V7ZM15 11H17V17H15V11ZM7 13H9V17H7V13ZM15 4H5V20H19V8H15V4ZM3 2.9918C3 2.44405 3.44749 2 3.9985 2H16L20.9997 7L21 20.9925C21 21.5489 20.5551 22 20.0066 22H3.9934C3.44476 22 3 21.5447 3 21.0082V2.9918Z"], ["routerLink", "/admin/expenses", "routerLinkActive", "active", "routerDirection", "root", 1, "sidebar_nav_menu"], ["d", "M22.0049 6.99979H23.0049V16.9998H22.0049V19.9998C22.0049 20.5521 21.5572 20.9998 21.0049 20.9998H3.00488C2.4526 20.9998 2.00488 20.5521 2.00488 19.9998V3.99979C2.00488 3.4475 2.4526 2.99979 3.00488 2.99979H21.0049C21.5572 2.99979 22.0049 3.4475 22.0049 3.99979V6.99979ZM20.0049 16.9998H14.0049C11.2435 16.9998 9.00488 14.7612 9.00488 11.9998C9.00488 9.23836 11.2435 6.99979 14.0049 6.99979H20.0049V4.99979H4.00488V18.9998H20.0049V16.9998ZM21.0049 14.9998V8.99979H14.0049C12.348 8.99979 11.0049 10.3429 11.0049 11.9998C11.0049 13.6566 12.348 14.9998 14.0049 14.9998H21.0049ZM14.0049 10.9998H17.0049V12.9998H14.0049V10.9998Z"]], template: function SidebarComponent_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275element(27, "path", 14);
    \u0275\u0275elementEnd();
    \u0275\u0275text(28, " Expenses ");
    \u0275\u0275elementEnd()()();
  }
}, dependencies: [RouterLink, RouterLinkActive], styles: ['\n\n@font-face {\n  font-family: "Poppins-Bold";\n  src: url("./media/Poppins-Bold.ttf") format("truetype");\n}\n.sidebar[_ngcontent-%COMP%] {\n  width: 258px;\n  border-right: 1px solid #dbe0e6;\n  height: 100%;\n}\n.sidebar_header[_ngcontent-%COMP%] {\n  font-family: "Poppins-Bold", sans-serif;\n  display: flex;\n  align-items: center;\n  column-gap: 10px;\n  padding: 10px 24px;\n  border-bottom: 1px solid #dbe0e6;\n}\n.sidebar_header[_ngcontent-%COMP%]   img[_ngcontent-%COMP%] {\n  width: 80px;\n}\n.sidebar_header[_ngcontent-%COMP%]   div[_ngcontent-%COMP%] {\n  line-height: 1;\n  text-align: right;\n}\n.sidebar_header[_ngcontent-%COMP%]   div[_ngcontent-%COMP%]   div[_ngcontent-%COMP%]:nth-of-type(1) {\n  font-size: 10px;\n  color: #fb0;\n}\n.sidebar_header[_ngcontent-%COMP%]   div[_ngcontent-%COMP%]   div[_ngcontent-%COMP%]:nth-of-type(2) {\n  font-size: 20px;\n}\n.sidebar_nav[_ngcontent-%COMP%] {\n  padding: 24px;\n}\n.sidebar_nav_menu[_ngcontent-%COMP%] {\n  align-items: flex-start;\n  display: flex;\n  cursor: pointer;\n  column-gap: 10px;\n  color: #5b6670;\n  padding: 10px 10px 10px 18px;\n}\n.sidebar_nav_menu[_ngcontent-%COMP%]   svg[_ngcontent-%COMP%] {\n  width: 20px;\n}\n.sidebar_nav_menu[_ngcontent-%COMP%]:hover {\n  color: #FE9F43;\n}\n.active[_ngcontent-%COMP%] {\n  color: #FE9F43;\n  border-radius: 5px;\n  background: rgba(254, 159, 67, 0.08);\n}\n/*# sourceMappingURL=sidebar.component.css.map */'] });
...
var _c05 = (a0) => ({ "open": a0 });
function AdminComponent_div_1_div_12_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "div", 13);
  }
}
function AdminComponent_div_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function AdminComponent_div_1_Template_svg_click_2_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275listener("click", function AdminComponent_div_1_Template_svg_click_6_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.toggleDrawer());
    });
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(8, "div", 10)(9, "div")(10, "div", 11);
    \u0275\u0275element(11, "app-sidebar");
    \u0275\u0275elementEnd()()()()();
    \u0275\u0275template(12, AdminComponent_div_1_div_12_Template, 1, 0, "div", 12);
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance(4);
    \u0275\u0275property("ngClass", \u0275\u0275pureFunction1(2, _c05, ctx_r1.isOpen));
    \u0275\u0275advance(8);
...
_AdminComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AdminComponent, selectors: [["app-admin"]], hostBindings: function AdminComponent_HostBindings(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275listener("resize", function AdminComponent_resize_HostBindingHandler($event) {
      return ctx.onResize($event);
    }, false, \u0275\u0275resolveWindow);
  }
}, decls: 3, vars: 2, consts: [[1, "admin"], ["style", "width: 100%;", 4, "ngIf"], ["class", "admin_content", 4, "ngIf"], [2, "width", "100%"], [1, "admin_mobile"], ["xmlns", "http://www.w3.org/2000/svg", "viewBox", "0 0 24 24", "fill", "currentColor", 3, "click"], ["d", "M3 4H21V6H3V4ZM3 11H21V13H3V11ZM3 18H21V20H3V18Z"], [1, "admin_mobile_sidenav", 3, "ngClass"], [1, "admin_mobile_sidenav_header"], ["d", "M11.9997 10.5865L16.9495 5.63672L18.3637 7.05093L13.4139 12.0007L18.3637 16.9504L16.9495 18.3646L11.9997 13.4149L7.04996 18.3646L5.63574 16.9504L10.5855 12.0007L5.63574 7.05093L7.04996 5.63672L11.9997 10.5865Z"], [1, "admin_mobile_sidenav_user"], [2, "margin-top", "10px"], ["class", "overlay", 4, "ngIf"], [1, "overlay"], [1, "admin_content"], [1, "admin_content_web"]], template: function AdminComponent_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 0);
    \u0275\u0275template(1, AdminComponent_div_1_Template, 14, 4, "div", 1)(2, AdminComponent_div_2_Template, 4, 0, "div", 2);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx.isMobile === true);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", !ctx.isMobile);
  }
}, dependencies: [NgClass, NgIf, RouterOutlet, SidebarComponent], styles: ['\n\n@font-face {\n  font-family: "NunitoSans";\n  src: url("./media/NunitoSans.ttf") format("truetype");\n}\n.admin[_ngcontent-%COMP%] {\n  font-family: "NunitoSans";\n  display: flex;\n  min-width: 100%;\n  min-height: 100vh;\n}\n.admin_content[_ngcontent-%COMP%] {\n  width: 100%;\n  display: flex;\n}\n.admin_content_web[_ngcontent-%COMP%] {\n  background-color: #FAFBFE;\n  width: 100%;\n  padding: 24px;\n}\n.admin_mobile[_ngcontent-%COMP%] {\n  padding: 15px;\n  justify-content: space-between;\n  box-shadow: 0 6px 15px rgba(64, 79, 104, 0.05);\n  border-bottom: 1px solid #E5E5E5;\n}\n.admin_mobile[_ngcontent-%COMP%]   img[_ngcontent-%COMP%] {\n  width: 60px;\n}\n.admin_mobile[_ngcontent-%COMP%]   svg[_ngcontent-%COMP%] {\n  width: 25px;\n}\n.admin_mobile_sidenav[_ngcontent-%COMP%] {\n  height: 100%;\n  width: 0;\n  position: fixed;\n  top: 0;\n  left: 0;\n  background-color: #FFFFFF;\n  overflow-x: hidden;\n  transition: 0.5s;\n  padding-top: 60px;\n}\n.admin_mobile_sidenav_header[_ngcontent-%COMP%] {\n  display: flex;\n  justify-content: space-between;\n  border-bottom: 1px solid #E5E5E5;\n  padding: 10px 15px;\n}\n.admin_mobile_sidenav_header[_ngcontent-%COMP%]   img[_ngcontent-%COMP%] {\n  width: 80px;\n}\n.admin_mobile_sidenav_header[_ngcontent-%COMP%]   svg[_ngcontent-%COMP%] {\n  width: 25px;\n}\n.admin_mobile_sidenav_menu[_ngcontent-%COMP%] {\n  padding: 15px;\n}\n.admin_mobile_sidenav_menu_text[_ngcontent-%COMP%] {\n  text-transform: capitalize;\n  cursor: pointer;\n  text-align: center;\n  align-items: end;\n  display: flex;\n}\n@media (max-width: 575.98px) {\n  .admin_mobile_sidenav_menu_text[_ngcontent-%COMP%] {\n    display: block;\n    padding: 12px 0;\n  }\n}\n@media (max-width: 575.98px) {\n  .admin_mobile_sidenav_menu_text[_ngcontent-%COMP%]   div[_ngcontent-%COMP%] {\n    padding: 12px 0;\n  }\n}\n.admin_mobile_sidenav_menu_text[_ngcontent-%COMP%]:last-of-type {\n  font-weight: 700;\n  border: 1px solid #14a077;\n  color: #121212;\n  background: #fff;\n  border-radius: 4px;\n  text-align: center;\n}\n.admin_mobile_sidenav_menu[_ngcontent-%COMP%]   span[_ngcontent-%COMP%] {\n  width: 100%;\n}\n.admin_mobile_sidenav_user[_ngcontent-%COMP%] {\n  display: grid;\n  justify-content: center;\n  text-align: center;\n  text-transform: capitalize;\n}\n.admin_mobile_sidenav_user_role[_ngcontent-%COMP%] {\n  text-align: center;\n  color: #64666c;\n  font-size: 12px;\n  text-transform: lowercase;\n}\n.admin_menu[_ngcontent-%COMP%] {\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n}\n.admin_menu_nav[_ngcontent-%COMP%] {\n  display: flex;\n  width: 50%;\n  justify-content: space-between;\n  align-items: center;\n  text-transform: capitalize;\n}\n.admin_menu[_ngcontent-%COMP%]   img[_ngcontent-%COMP%] {\n  width: 50px;\n  border-radius: 50%;\n}\n.admin_menu[_ngcontent-%COMP%]   span[_ngcontent-%COMP%] {\n  padding: 10px 30px;\n  cursor: pointer;\n}\n.admin_menu[_ngcontent-%COMP%]   span[_ngcontent-%COMP%]:hover {\n  background-color: #14a077;\n  color: #FFFFFF;\n  border-radius: 4px;\n}\n.admin_menu_login[_ngcontent-%COMP%] {\n  font-weight: 700;\n  border: 1px solid #14a077;\n  color: #121212;\n  background: #fff;\n  border-radius: 4px;\n  text-align: center;\n  padding: 10px 30px;\n  cursor: pointer;\n}\n.admin_menu_login[_ngcontent-%COMP%]   span[_ngcontent-%COMP%] {\n  padding: 0;\n}\n.admin_menu_login[_ngcontent-%COMP%]:hover {\n  background-color: #14a077;\n  color: #FFFFFF;\n}\n.admin_menu_dropdown[_ngcontent-%COMP%] {\n  border: none;\n  display: flex;\n  align-items: baseline;\n  color: #121212;\n}\n.admin_menu_dropdown_role[_ngcontent-%COMP%] {\n  text-align: left;\n  color: #64666c;\n  font-size: 12px;\n}\n.admin_menu_dropdown[_ngcontent-%COMP%]:hover {\n  background: transparent;\n  color: #121212;\n}\n.open[_ngcontent-%COMP%] {\n  width: 250px;\n  z-index: 2;\n  padding: 0;\n}\n.menu_nav[_ngcontent-%COMP%]   span[_ngcontent-%COMP%] {\n  padding: 10px 30px;\n}\n.overlay[_ngcontent-%COMP%] {\n  background-color: rgba(0, 0, 0, 0.5);\n  width: 100%;\n  height: 100%;\n  position: absolute;\n  top: 0;\n  z-index: 1;\n}\n/*# sourceMappingURL=admin.component.css.map */'] });
...
function OrdersComponent_div_15_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 12)(1, "div", 6);
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275pipe(9, "date");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(10, "div", 10)(11, "div", 13);
    \u0275\u0275listener("click", function OrdersComponent_div_15_Template_div_click_11_listener() {
      const data_r2 = \u0275\u0275restoreView(_r1).$implicit;
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.openModal(data_r2));
    });
    \u0275\u0275text(12, " view ");
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", data_r2.qty, " ");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" PHP ", data_r2.total, " ");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(9, 4, data_r2.datetime, "EEEE, MMMM d, y, h:mm:ss"), " ");
  }
}
function OrdersComponent_ng_template_16_div_33_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 25)(1, "div", 6);
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "div", 7);
    \u0275\u0275text(4);
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", order_r4.product, " ");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" PHP ", order_r4.price, " ");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", order_r4.quantity, " ");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" PHP ", order_r4.total, " ");
  }
}
function OrdersComponent_ng_template_16_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(10, " Invoice ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(11, "div", 19)(12, "div", 20)(13, "div");
    \u0275\u0275text(14, "Invoice #:");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(15, "div");
    \u0275\u0275text(16);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(17, "div", 20)(18, "div");
    \u0275\u0275text(19, "Date:");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275pipe(22, "date");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(23, "div", 21)(24, "div", 22)(25, "div", 6);
    \u0275\u0275text(26, "Item");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(32, "Total");
    \u0275\u0275elementEnd()();
    \u0275\u0275template(33, OrdersComponent_ng_template_16_div_33_Template, 9, 4, "div", 23);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(34, "div", 20)(35, "div");
    \u0275\u0275text(36, "Items:");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(37, "div");
    \u0275\u0275text(38);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(39, "div", 24)(40, "div");
    \u0275\u0275text(41, "Total Payable:");
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275advance(16);
    \u0275\u0275textInterpolate(ctx_r2.details == null ? null : ctx_r2.details.transactionid);
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind2(22, 5, ctx_r2.details == null ? null : ctx_r2.details.datetime, "EEEE, MMMM d, y, h:mm:ss"));
    \u0275\u0275advance(12);
    \u0275\u0275property("ngForOf", ctx_r2.details == null ? null : ctx_r2.details.orders);
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(ctx_r2.details == null ? null : ctx_r2.details.qty);
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate1("PHP ", ctx_r2.details == null ? null : ctx_r2.details.total, "");
  }
}
var _OrdersComponent = class _OrdersComponent {
  constructor(salesService, modalService) {
    this.salesService = salesService;
    this.modalService = modalService;
    this.products = [];
    this.details = null;
...
_OrdersComponent.\u0275fac = function OrdersComponent_Factory(t) {
  return new (t || _OrdersComponent)(\u0275\u0275directiveInject(SalesService), \u0275\u0275directiveInject(ModalService));
};
_OrdersComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _OrdersComponent, selectors: [["app-orders"]], viewQuery: function OrdersComponent_Query(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275viewQuery(_c06, 5);
  }
  if (rf & 2) {
...
}, decls: 18, vars: 1, consts: [["sales", ""], [1, "inventory"], [1, "inventory_title"], [1, "inventory_table"], [1, "inventory_table_filter"], [1, "inventory_table_header"], [1, "table_one"], [1, "table_two"], [1, "table_three"], [1, "table_four"], [1, "table_five"], ["class", "inventory_table_list", 4, "ngFor", "ngForOf"], [1, "inventory_table_list"], [3, "click"], [1, "modal-content", 2, "width", "424px"], [1, "invoice"], [1, "invoice_header"], ["src", "assets/img/logo.png"], [1, "invoice_text"], [1, "invoice_body"], [1, "invoice_body_header"], [1, "invoice_body_table"], [1, "invoice_body_table_header"], ["class", "invoice_body_table_data", 4, "ngFor", "ngForOf"], [1, "invoice_body_total"], [1, "invoice_body_table_data"]], template: function OrdersComponent_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 1)(1, "div", 2);
    \u0275\u0275text(2, " Sales ");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275element(14, "div", 10);
    \u0275\u0275elementEnd();
    \u0275\u0275template(15, OrdersComponent_div_15_Template, 13, 7, "div", 11);
    \u0275\u0275elementEnd()();
    \u0275\u0275template(16, OrdersComponent_ng_template_16_Template, 44, 8, "ng-template", null, 0, \u0275\u0275templateRefExtractor);
  }
  if (rf & 2) {
    \u0275\u0275advance(15);
    \u0275\u0275property("ngForOf", ctx.products);
  }
}, dependencies: [NgForOf, DatePipe], styles: ['\n\n@media (max-width: 575.98px) {\n  .inventory[_ngcontent-%COMP%] {\n    padding: 20px;\n  }\n}\n.inventory_title[_ngcontent-%COMP%] {\n  display: flex;\n  justify-content: space-between;\n  font-weight: 700;\n  color: #092C4C;\n  font-size: 18px;\n  margin-bottom: 24px;\n}\n.inventory_title_add[_ngcontent-%COMP%] {\n  background: #FF9F43;\n  cursor: pointer;\n  padding: 8px 11px;\n  color: #ffffff;\n  font-size: 14px;\n  border-radius: 8px;\n}\n.inventory_title_add[_ngcontent-%COMP%]:hover {\n  background: #ffbb00;\n}\n.inventory_table[_ngcontent-%COMP%] {\n  margin-bottom: 1.5rem;\n  background-color: #ffffff;\n  transition: all 0.5s ease-in-out;\n  position: relative;\n  border-radius: 4px;\n  border: 1px solid #dbe0e6;\n  box-shadow: none;\n  padding: 24px;\n}\n@media (max-width: 575.98px) {\n  .inventory_table[_ngcontent-%COMP%] {\n    padding: 15px;\n    display: grid;\n    overflow-x: auto;\n  }\n}\n.inventory_table_header[_ngcontent-%COMP%] {\n  display: flex;\n  justify-content: space-between;\n  padding: 0 24px;\n  padding-bottom: 0.75rem;\n  border-bottom: 1px solid #dbe0e6;\n}\n.inventory_table_header[_ngcontent-%COMP%]   div[_ngcontent-%COMP%] {\n  font-weight: 600;\n  font-size: 15px;\n}\n.inventory_table_list[_ngcontent-%COMP%] {\n  display: flex;\n  justify-content: space-between;\n  padding: 24px;\n  color: #092C4C;\n  font-size: 14px;\n  font-weight: 400;\n  line-height: normal;\n  border-bottom: 1px solid #dbe0e6;\n}\n.inventory_table_list_add[_ngcontent-%COMP%]:hover {\n  background-color: #051a2c !important;\n  border: 1px solid #051a2c !important;\n  box-shadow: 0 3px 10px rgba(9, 44, 76, 0.5);\n}\n.table_one[_ngcontent-%COMP%] {\n  width: 200px;\n}\n.table_two[_ngcontent-%COMP%] {\n  width: 100px;\n}\n.table_three[_ngcontent-%COMP%] {\n  width: 100px;\n}\n.table_four[_ngcontent-%COMP%] {\n  width: 100px;\n}\n.table_five[_ngcontent-%COMP%] {\n  width: 80px;\n}\n.table_five[_ngcontent-%COMP%]   div[_ngcontent-%COMP%] {\n  cursor: pointer;\n  border-radius: 3px;\n  text-align: center;\n  padding: 0.25rem 0.5rem;\n  font-size: 0.75rem;\n  background-color: #092C4C !important;\n  border: 1px solid #092C4C !important;\n  color: #ffffff;\n  box-shadow: 0 4px 20px rgba(9, 44, 76, 0.15);\n}\n.table_five[_ngcontent-%COMP%]   div[_ngcontent-%COMP%]:hover {\n  background-color: #051a2c !important;\n  border: 1px solid #051a2c !important;\n  box-shadow: 0 3px 10px rgba(9, 44, 76, 0.5);\n}\n.modal-header[_ngcontent-%COMP%] {\n  font-size: 16px;\n  font-weight: 600;\n  color: #1B2850;\n}\n.modal-header[_ngcontent-%COMP%]   span[_ngcontent-%COMP%] {\n  color: #FF9F43;\n  padding-left: 5px;\n}\n.modal-body-label[_ngcontent-%COMP%] {\n  font-size: 14px;\n  color: #5B6670;\n  margin-bottom: 8px;\n  text-transform: capitalize;\n}\n.modal-btns[_ngcontent-%COMP%] {\n  column-gap: 10px;\n  display: flex;\n  justify-content: end;\n  padding: 20px 0;\n  padding-bottom: 0;\n}\n.modal-btns-cancel[_ngcontent-%COMP%] {\n  background: #67748E;\n  color: #ffffff;\n}\n.modal-btns-cancel[_ngcontent-%COMP%]:hover {\n  background: #424b52;\n}\n.modal-btns-add[_ngcontent-%COMP%] {\n  background: #FF9F43;\n  color: #ffffff;\n}\n.modal-btns-add[_ngcontent-%COMP%]:hover {\n  background: #ffbb00;\n}\n.btn[_ngcontent-%COMP%] {\n  border-radius: 3px;\n  padding: 0.625rem 1.25rem;\n  padding: 0.5rem 0.85rem;\n  font-size: 0.85rem;\n  transition: all 0.5s;\n}\ninput[_ngcontent-%COMP%] {\n  border-color: #e9edf6;\n  color: #5B6670;\n  font-size: 0.875rem;\n  line-height: 1.6;\n  padding: 0.5rem 0.85rem;\n  margin-bottom: 1rem;\n}\n[_ngcontent-%COMP%]::placeholder {\n  color: #8b949b;\n}\n.invoice[_ngcontent-%COMP%] {\n  padding: 30px;\n  padding-top: 15px;\n  color: #5B6670;\n}\n@media (max-width: 575.98px) {\n  .invoice[_ngcontent-%COMP%] {\n    padding: 10px;\n  }\n}\n.invoice_header[_ngcontent-%COMP%] {\n  font-family: "Poppins-Bold", sans-serif;\n  justify-content: center;\n  display: flex;\n  align-items: center;\n  column-gap: 10px;\n}\n.invoice_header[_ngcontent-%COMP%]   img[_ngcontent-%COMP%] {\n  width: 80px;\n}\n.invoice_header[_ngcontent-%COMP%]   div[_ngcontent-%COMP%] {\n  line-height: 1;\n  text-align: right;\n}\n.invoice_header[_ngcontent-%COMP%]   div[_ngcontent-%COMP%]   div[_ngcontent-%COMP%]:nth-of-type(1) {\n  font-size: 10px;\n  color: #fb0;\n}\n.invoice_header[_ngcontent-%COMP%]   div[_ngcontent-%COMP%]   div[_ngcontent-%COMP%]:nth-of-type(2) {\n  font-size: 20px;\n}\n.invoice_text[_ngcontent-%COMP%] {\n  margin: 10px 0;\n  font-weight: 600;\n  position: relative;\n  text-align: center;\n}\n.invoice_text[_ngcontent-%COMP%]:before {\n  -webkit-transform: translateY(-50%);\n  -ms-transform: translateY(-50%);\n  content: "";\n  border-top: 1px dashed #5B6670;\n  width: 35%;\n  position: absolute;\n  top: 50%;\n  left: 0;\n}\n.invoice_text[_ngcontent-%COMP%]:after {\n  -webkit-transform: translateY(-50%);\n  -ms-transform: translateY(-50%);\n  content: "";\n  border-top: 1px dashed #5B6670;\n  width: 35%;\n  position: absolute;\n  top: 50%;\n  right: 0;\n}\n.invoice_body[_ngcontent-%COMP%] {\n  font-size: 14px;\n}\n.invoice_body_header[_ngcontent-%COMP%], .invoice_body_total[_ngcontent-%COMP%] {\n  justify-content: space-between;\n  display: flex;\n}\n.invoice_body_table[_ngcontent-%COMP%] {\n  border-top: 1px dashed #5B6670;\n  border-bottom: 1px dashed #5B6670;\n  padding-bottom: 5px;\n  margin: 15px 0;\n}\n.invoice_body_table_header[_ngcontent-%COMP%] {\n  display: flex;\n  padding: 5px;\n  color: #092C4C;\n  font-weight: bold;\n  margin-bottom: 5px;\n  border-bottom: 1px dashed #5B6670;\n}\n.invoice_body_table_data[_ngcontent-%COMP%] {\n  display: flex;\n  padding: 5px;\n}\n.invoice_body_total[_ngcontent-%COMP%] {\n  font-weight: 500;\n  font-size: 15px;\n  color: #092C4C;\n  margin-top: 5px;\n}\n.modal-content[_ngcontent-%COMP%] {\n  width: 424px !important;\n  margin: 0 auto;\n}\n@media (max-width: 575.98px) {\n  .modal-content[_ngcontent-%COMP%] {\n    width: 250px !important;\n  }\n}\n.table_one[_ngcontent-%COMP%] {\n  width: 200px;\n}\n.table_two[_ngcontent-%COMP%] {\n  width: 90px;\n}\n.table_three[_ngcontent-%COMP%] {\n  width: 100px;\n}\n.table_four[_ngcontent-%COMP%] {\n  width: 190px;\n}\n/*# sourceMappingURL=orders.component.css.map */'] });
...
var _MembersService = class _MembersService {
  constructor(http, webSocketService) {
    this.http = http;
    this.webSocketService = webSocketService;
    this.API_URL = "https://pos-backend-kt9t.vercel.app/";
...
_MembersService.\u0275fac = function MembersService_Factory(t) {
  return new (t || _MembersService)(\u0275\u0275inject(HttpClient), \u0275\u0275inject(WebSocketService));
};
_MembersService.\u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({ token: _MembersService, factory: _MembersService.\u0275fac, providedIn: "root" });
var MembersService = _MembersService;

// src/app/admin/members/members.component.ts
var _c07 = ["addProductModal"];
function MembersComponent_ng_template_20_Template(rf, ctx) {
  if (rf & 1) {
    const _r2 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 14);
    \u0275\u0275text(1, " Add member ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(2, "div")(3, "div", 15)(4, "form", 16);
    \u0275\u0275listener("submit", function MembersComponent_ng_template_20_Template_form_submit_4_listener() {
      \u0275\u0275restoreView(_r2);
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.addProduct());
    });
    \u0275\u0275elementStart(5, "label", 17);
    \u0275\u0275text(6, "Name:");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(7, "input", 18);
    \u0275\u0275twoWayListener("ngModelChange", function MembersComponent_ng_template_20_Template_input_ngModelChange_7_listener($event) {
      \u0275\u0275restoreView(_r2);
      const ctx_r2 = \u0275\u0275nextContext();
      \u0275\u0275twoWayBindingSet(ctx_r2.newProduct.name, $event) || (ctx_r2.newProduct.name = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(8, "div", 19)(9, "button", 20);
    \u0275\u0275listener("click", function MembersComponent_ng_template_20_Template_button_click_9_listener() {
      \u0275\u0275restoreView(_r2);
      const ctx_r2 = \u0275\u0275nextContext();
  ...
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275advance(7);
    \u0275\u0275twoWayProperty("ngModel", ctx_r2.newProduct.name);
  }
}
function MembersComponent_ng_template_22_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "app-no-data");
  }
}
var _MembersComponent = class _MembersComponent {
  constructor(modalService, membersService, webSocketService) {
    this.modalService = modalService;
...
_MembersComponent.\u0275fac = function MembersComponent_Factory(t) {
  return new (t || _MembersComponent)(\u0275\u0275directiveInject(ModalService), \u0275\u0275directiveInject(MembersService), \u0275\u0275directiveInject(WebSocketService));
};
_MembersComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _MembersComponent, selectors: [["app-members"]], viewQuery: function MembersComponent_Query(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275viewQuery(_c07, 5);
  }
  if (rf & 2) {
...
}, decls: 24, vars: 0, consts: [["addProductModal", ""], ["noData", ""], [1, "products"], [1, "products_title"], [1, "products_title_add", 3, "click"], [1, "products_table"], [1, "products_table_filter"], [1, "products_table_header"], [1, "table_one"], [1, "table_two"], [1, "table_three"], [1, "table_four"], [1, "table_five"], [1, "table_six"], [1, "modal-header"], [1, "modal-body"], [3, "submit"], ["for", "productName", 1, "modal-body-label"], ["type", "text", "id", "productName", "name", "productName", "required", "", 1, "form-control", 3, "ngModelChange", "ngModel"], [1, "modal-btns"], ["type", "button", 1, "btn", "modal-btns-cancel", 3, "click"], ["type", "submit", 1, "btn", "modal-btns-add"]], template: function MembersComponent_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 2)(1, "div", 3);
    \u0275\u0275text(2, " Members ");
    \u0275\u0275elementStart(3, "div", 4);
    \u0275\u0275listener("click", function MembersComponent_Template_div_click_3_listener() {
      \u0275\u0275restoreView(_r1);
      return \u0275\u0275resetView(ctx.addModal());
    });
    \u0275\u0275text(4, " Add member ");
    ...
    \u0275\u0275text(11, "Date Joined");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(12, "div", 10);
    \u0275\u0275text(13, "Coffee");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(14, "div", 11);
    \u0275\u0275text(15, "Total Load");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(16, "div", 12);
    \u0275\u0275text(17, "Total Spent");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(18, "div", 13);
    \u0275\u0275text(19, "Last Spent");
    \u0275\u0275elementEnd()()()();
    \u0275\u0275template(20, MembersComponent_ng_template_20_Template, 13, 1, "ng-template", null, 0, \u0275\u0275templateRefExtractor)(22, MembersComponent_ng_template_22_Template, 1, 0, "ng-template", null, 1, \u0275\u0275templateRefExtractor);
  }
}, dependencies: [\u0275NgNoValidate, DefaultValueAccessor, NgControlStatus, NgControlStatusGroup, RequiredValidator, NgModel, NgForm, NoDataComponent], styles: ["\n\n@media (max-width: 575.98px) {\n  .products[_ngcontent-%COMP%] {\n    padding: 20px;\n  }\n}\n.products_title[_ngcontent-%COMP%] {\n  display: flex;\n  justify-content: space-between;\n  font-weight: 700;\n  color: #092C4C;\n  font-size: 18px;\n  margin-bottom: 24px;\n}\n.products_title_add[_ngcontent-%COMP%] {\n  background: #FF9F43;\n  cursor: pointer;\n  padding: 8px 11px;\n  color: #ffffff;\n  font-size: 14px;\n  border-radius: 8px;\n}\n.products_title_add[_ngcontent-%COMP%]:hover {\n  background: #ffbb00;\n}\n.products_table[_ngcontent-%COMP%] {\n  margin-bottom: 1.5rem;\n  background-color: #ffffff;\n  transition: all 0.5s ease-in-out;\n  position: relative;\n  border-radius: 4px;\n  border: 1px solid #dbe0e6;\n  box-shadow: none;\n  padding: 24px;\n}\n@media (max-width: 575.98px) {\n  .products_table[_ngcontent-%COMP%] {\n    padding: 15px;\n    display: grid;\n    overflow-x: auto;\n  }\n}\n.products_table_header[_ngcontent-%COMP%] {\n  display: flex;\n  justify-content: space-between;\n  padding: 0 24px;\n  padding-bottom: 0.75rem;\n  border-bottom: 1px solid #dbe0e6;\n}\n.products_table_header[_ngcontent-%COMP%]   div[_ngcontent-%COMP%] {\n  font-weight: 600;\n  font-size: 15px;\n}\n.products_table_list[_ngcontent-%COMP%] {\n  display: flex;\n  justify-content: space-between;\n  padding: 24px;\n  color: #092C4C;\n  font-size: 14px;\n  font-weight: 400;\n  line-height: normal;\n  border-bottom: 1px solid #dbe0e6;\n}\n.products_table_list_add[_ngcontent-%COMP%] {\n  cursor: pointer;\n  border-radius: 3px;\n  text-align: center;\n  padding: 0.25rem 0.5rem;\n  font-size: 0.75rem;\n  background-color: #092C4C !important;\n  border: 1px solid #092C4C !important;\n  color: #ffffff;\n  box-shadow: 0 4px 20px rgba(9, 44, 76, 0.15);\n}\n.products_table_list_add[_ngcontent-%COMP%]:hover {\n  background-color: #051a2c !important;\n  border: 1px solid #051a2c !important;\n  box-shadow: 0 3px 10px rgba(9, 44, 76, 0.5);\n}\n.table_one[_ngcontent-%COMP%] {\n  width: 200px;\n}\n.table_two[_ngcontent-%COMP%] {\n  width: 100px;\n}\n.table_three[_ngcontent-%COMP%] {\n  width: 100px;\n}\n.table_four[_ngcontent-%COMP%] {\n  width: 100px;\n}\n.table_five[_ngcontent-%COMP%] {\n  width: 80px;\n}\n.table_six[_ngcontent-%COMP%] {\n  width: 80px;\n}\n.modal-header[_ngcontent-%COMP%] {\n  font-size: 16px;\n  font-weight: 600;\n  color: #1B2850;\n}\n.modal-header[_ngcontent-%COMP%]   span[_ngcontent-%COMP%] {\n  color: #FF9F43;\n  padding-left: 5px;\n}\n.modal-body-label[_ngcontent-%COMP%] {\n  font-size: 14px;\n  color: #5B6670;\n  margin-bottom: 8px;\n  text-transform: capitalize;\n}\n.modal-btns[_ngcontent-%COMP%] {\n  column-gap: 10px;\n  display: flex;\n  justify-content: end;\n  padding: 20px 0;\n  padding-bottom: 0;\n}\n.modal-btns-cancel[_ngcontent-%COMP%] {\n  background: #67748E;\n  color: #ffffff;\n}\n.modal-btns-cancel[_ngcontent-%COMP%]:hover {\n  background: #424b52;\n}\n.modal-btns-add[_ngcontent-%COMP%] {\n  background: #FF9F43;\n  color: #ffffff;\n}\n.modal-btns-add[_ngcontent-%COMP%]:hover {\n  background: #ffbb00;\n}\n.btn[_ngcontent-%COMP%] {\n  border-radius: 3px;\n  padding: 0.625rem 1.25rem;\n  padding: 0.5rem 0.85rem;\n  font-size: 0.85rem;\n  transition: all 0.5s;\n}\ninput[_ngcontent-%COMP%] {\n  border-color: #e9edf6;\n  color: #5B6670;\n  font-size: 0.875rem;\n  line-height: 1.6;\n  padding: 0.5rem 0.85rem;\n  margin-bottom: 1rem;\n}\n[_ngcontent-%COMP%]::placeholder {\n  color: #8b949b;\n}\n/*# sourceMappingURL=members.component.css.map */"] });
var MembersComponent = _MembersComponent;
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(MembersComponent, { className: "MembersComponent" });
})();
...
_AppRoutingModule.\u0275inj = /* @__PURE__ */ \u0275\u0275defineInjector({ imports: [RouterModule.forRoot(routes, { preloadingStrategy: PreloadAllModules, useHash: true }), RouterModule] });
...
@angular/core/fesm2022/rxjs-interop.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-6SOQEUAB.mjs.map
